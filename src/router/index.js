  ...
  return (
    <ScrollToTop>
      <Routes>
        ...
        <Route path="assign-request-tech" element={<AssignRequestToTech />} />
        <Route
        ...
        <Route path="masters">
          ...
          <Route path="billing-address" element={<BillingAddressListPage />} />
          <Route path="service-type" element={<ServiceTypeList />} />
          <Route path="service-type-view/:id" element={<ServiceTypeView />} />
          <Route
        ...
        <Route path="stake-holder-view/:id" element={<StakeHolderViewPage />} />
        <Route path="stake-holder-edit/:id" element={<StakeHolderEdit />} />
        <Route path="issue-new-reeler-license" element={<NewReelerLicense />} />
        <Route path="reeler-license-list" element={<ReelerLicenseList />} />
        <Route path="reeler-license-view/:id" element={<ReelerLicenseView />} />
        <Route path="reeler-license-edit/:id" element={<ReelerLicenceEdit />} />
        <Route path="renew-reeler-license" element={<RenewReelerLicense />} />
        <Route
          path="transfer-reeler-license"
          element={<TransferReelerLicense />}
        />
        <Route path="issue-new-trader-license" element={<NewTraderLicense />} />
        <Route
        ...
        />
        <Route
          path="trainer-page-edit/:id"
          element={<TrainerPageEdit />}
        />
        <Route
          path="trainer-page-list"
          element={<TrainerPageList />}
        />
        <Route
        ...
        />
        <Route path="training-deputation-tracker-list" element={<TrainingDeputationTrackerList />} />
        <Route path="training-deputation-tracker-view/:id" element={<TrainingDeputationTrackerView />} />
        <Route path="training-deputation-tracker-edit/:id" element={<TrainingDeputationTrackerEdit />} />

        {/* Services */}
        <Route path="track-dfl-procurement" element={<TrackDflProcurement />} />
        <Route
        ...
        />
        <Route path="providing-incentives" element={<ProvidingIncentives />} />
        <Route path="providing-subsidy" element={<ProvidingSubsidy />} />
        <Route path="preparation-dc-bills" element={<PreparationDcBills />} />
        <Route
        ...
        {/* Target Setting */}
        <Route path="attribute-assigning" element={<AttributesAssigning />} />
        ...
        <Route path="relationship-view/:id" element={<RelationshipView />} />
        <Route path="relationship-edit/:id" element={<RelationshipEdit />} />
        ...
        <Route path="land-category-view/:id" element={<LandCategoryView />} />
        <Route path="land-category-edit/:id" element={<LandCategoryEdit />} />
        ...
        <Route path="irrigation-type-list" element={<IrrigationTypeList />} />
        <Route
        ...
        <Route path="land-ownership-view/:id" element={<LandOwnershipView />} />
        <Route path="land-ownership-edit/:id" element={<LandOwnershipEdit />} />
        ...
        <Route path="rear-house-roof-type" element={<RearHouseRoofType />} />
        <Route
        ...
        <Route path="mulberry-variety-list" element={<MulberryVarietyList />} />
        <Route
        ...
        <Route path="subsidy-details-list" element={<SubsidyDetailsList />} />
        <Route
        ...
        <Route path="plantation-type-list" element={<PlantationTypeList />} />
        <Route
        ...
        />
        <Route path="reason-bid-rejection" element={<ReasonBidRejection />} />
        <Route
        ...
        />
        <Route path="reeler-device-mapping" element={<ReelerDeviceMapping />} />
        ...
        <Route path="working-institution" element={<WorkingInstitution />} />
        <Route
        ...
        <Route path="trainingPrograms-list" element={<TrainingProgramList />} />
        <Route
        ...
        <Route path="trainingCourses-list" element={<TrainingCourseList />} />
        <Route
        ...
        <Route path="training-group-edit/:id" element={<TrainingGroupEdit/>}/>
        <Route path="training-group-view/:id" element={<TrainingGroupView/>}/>
        <Route path="training-institution" element={<TrainingInstitution />}/>
        <Route path="training-institution-list" element={<TrainingInstitutionList />}/>
        <Route path="training-institution-edit/:id" element={<TrainingInstitutionEdit/>}/>
        <Route path="training-institution-view/:id" element={<TrainingInstitutionView/>}/>
        <Route path="training-mode" element={<TrainingMode />}/>
        <Route path="training-mode-list" element={<TrainingModeList />}/>
        <Route path="training-mode-edit/:id" element={<TrainingModeEdit/>}/>
        <Route path="training-mode-view/:id" element={<TrainingModeView/>}/>
        <Route path="training-office" element={<TrainingOffice />}/>
        <Route path="training-office-list" element={<TrainingOfficeList />}/>
        <Route path="training-office-edit/:id" element={<TrainingOfficeEdit/>}/>
        <Route path="training-office-view/:id" element={<TrainingOfficeView/>}/>
        <Route path="deputed-institute" element={<TrainingDeputedInstitute />}/>
        ...
        <Route path="reject-farmer-auction" element={<RejectFarmerAuction />} />
        <Route path="generate-bidding-slip" element={<GenerateBiddingSlip />} />
        ...
        <Route path="bidding-report-reeler" element={<BiddingReportReeler />} />
