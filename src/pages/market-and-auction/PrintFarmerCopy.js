...
function PrintFarmerCopy() {
  ...
  return (
    <Layout title={t("Generated Bidding Slip")}>
      <style>{printFarmerCopyStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Generated Bidding Slip")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              {/* <ul className="d-flex">
              <li>
...
export default PrintFarmerCopy;
