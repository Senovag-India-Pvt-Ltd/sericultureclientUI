...
function SeedMarketTripletReport() {
  ...
  const handleGenerate = async (e) => {
    ...
    try {
      ...
      if (!pdfWindow) {
        ...
        a.href = pdfUrl; a.download = 'triplet-report.pdf';
  ...
  return (
    <Layout title={t("Generate Triplet")}>
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">{t("Generate Triplet")}</Block.Title>
          </Block.HeadContent>
        </Block.HeadBetween>
      </Block.Head>
...
export default SeedMarketTripletReport;
