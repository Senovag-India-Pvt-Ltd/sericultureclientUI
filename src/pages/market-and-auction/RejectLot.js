...
function RejectLot() {
  ...
  return (
    <Layout title={t("Reject Lot")} show="true">
      <style>{rejectLotStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("Reject Lot")}</Block.Title>
            {/* <nav>
              ...
              <Card>
                <Card.Body>
                  <Row className="g-gs">
                    ...
                    <Col lg="6">
                      <Card>
                        <Card.Header className="sh-section-header"><Icon name="file-text" /><span>{t("Lot Details")}</span></Card.Header>
                        <Card.Body>
                          <Row className="g-gs">
                            <Col lg="12">
