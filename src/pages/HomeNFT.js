...
import { Row, Col, Card, Dropdown, Table, Badge, Tooltip, OverlayTrigger } from 'react-bootstrap';
import { Icon, Media, MediaGroup, MediaText, CustomDropdownMenu, CustomDropdownToggle, OverlineTitle, ChartLegend, LinkList, LinkListItem } from '../components';
...
function HomeNFT() {
  ...
  let pendingOrdersData = {
    labels: ["Production Not Planned", "0% Completed", "<50% Completed", ">=50% Completed","Delivery Ready"],
    datasets: [
    {
        backgroundColor: [Colors.info, Colors.yellow, Colors.green, Colors.purple, Colors.red],
        data: [90, 170, 10, 60 ,50],
        hoverOffset: 4
    }
    ]
};
      ...
      <Col xxl="12">
              ...
              <Card.Body className="flex-grow-0 py-2">
                  <div className="card-title-group">
                      <div className="card-title">
                          <h5 className="title">Production Overview</h5>
                      </div>
                  ...
                  <thead className="table-light table-head-sm">
                      <tr>
                          ...
                          <th className="tb-col tb-col-end">
                            <OverlineTitle tag="span">FG Produced</OverlineTitle>
                          </th>
                          <th className="tb-col tb-col-end">
                            <OverlineTitle tag="span">RM Consumed</OverlineTitle>
                          </th>
                          <th className="tb-col tb-col-end">
                            <OverlineTitle tag="span">Scrap Generated</OverlineTitle>
                          </th>
                          <th className="tb-col tb-col-end">
                            <OverlineTitle tag="span">RM Rejected</OverlineTitle>
                          </th>
                      </tr>
                  </thead>
                  <tbody>
                      <tr>
                          <td className="tb-col">
                              <MediaGroup>
                                  ...
                                  <MediaText>
                                      <span className="title text-truncate">Month to Date</span>
                      ...
                      <tr>
                          <td className="tb-col">
                              <MediaGroup>
                                  ...
                                  <MediaText>
                                      <span className="title text-truncate">Last 30 Days </span>
                      ...
                      <tr>
                          <td className="tb-col">
                              <MediaGroup>
                                  ...
                                  <MediaText>
                                      <span className="title text-truncate">Financial Year to Date</span>
                      ...
                      <tr>
                          <td className="tb-col">
                              <MediaGroup>
                                  ...
                                  <MediaText>
                                      <span className="title text-truncate">Previous Financial Year</span>
        ...
        <Col md="6" xxl="6">
            <Card className="h-100">
                ...
                <div className="card-title-group">
                    <div className="card-title">
                        <h5 className="title">Pending Orders (OCs) in Production</h5>
                    </div>
                    <div className="card-tools">
                        <OverlayTrigger 
                        placement="left"
                        overlay={
                            <Tooltip id="tooltip-another">Pending Orders (OCs) in Production</Tooltip>
                        }>
                ...
                <div className="nk-chart-analytics-session-device mt-4">
                    <ChartDoughnut data={pendingOrdersData}/>
                </div>
