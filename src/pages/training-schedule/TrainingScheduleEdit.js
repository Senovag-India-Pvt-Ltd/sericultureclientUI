...
function TrainingScheduleEdit() {
  ...
  return (
    <Layout title={t("Edit Scheduled Training")}>
      <style>{trainingScheduleEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">
                {t("Edit Scheduled Training")}
              </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          ...
          <Card>
            <Card.Header className="sh-section-header">
              <Icon name="edit" />
              <span>{t("Edit Scheduled Training")}</span>
            </Card.Header>
            <Card.Body>
              {loading ? (
                  ...
                  <Col lg="6">
                    <Form.Group className="form-group mt-n4">
                      ...
                      <div className="form-control-wrap">
                        ...
                        >
                          <option value="">{t("Select Training Group Type")}</option>
                  ...
                  <Col lg="6">
                    <Form.Group className="form-group mt-n4">
                      ...
                      <div className="form-control-wrap">
                        ...
                        >
                          <option value="">{t("Select Training Program")}</option>
                  ...
                  <Col lg="6">
                    <Form.Group className="form-group mt-n4">
                      ...
                      <div className="form-control-wrap">
                        ...
                        >
                          <option value="">{t("Select Training Course")}</option>
...
const trainingScheduleEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
