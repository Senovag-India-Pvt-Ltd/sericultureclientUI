...
function ChawkidistributiontoFarmers() {
  ...
  return (
    <Layout title="Sale Of Chawki Worms To Farmers">
      <style>{chawkiDistributionFormStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">
                {t("Sale Of Chawki Worms To Farmers")}
              </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                ...
                <Card.Body>
                  <Row className="g-gs">
                    ...
                    <Col lg="4">
                      <Form.Group className="form-group mt-n4">
                        <Form.Label>
                          {t("Sold after 1st/2nd/3rd Moult")}<span className="text-danger">*</span>
                        </Form.Label>
                        <div className="form-control-wrap">
                          <Form.Select
                    ...
                    <Col lg="2">
                      <Form.Group className="form-group mt-n4">
                        <Form.Label htmlFor="sordfl">
                          {t("Hatching Date")}<span className="text-danger">*</span>
                        </Form.Label>
                        <div className="form-control-wrap">
                          <DatePicker
...
const chawkiDistributionFormStyles = `
  .sh-page-header {
    padding: 20px 24px;
