 ...
 const  navigate = useNavigate();
  ...
  const ReceiptOfDFLsDataColumns = [
    ...
    },
    {
      ...
      cell: (row) => <span>{row.lineNumber}</span>,
      sortable: true,
      hide: "md",
    },
    {
      name: "Line Of DFLs",
      selector: (row) => row.lineOfDFLs,
      cell: (row) => <span>{row.lineOfDFLs}</span>,
      sortable: true,
      hide: "md",
    },
    {
    ...
    {
        name: "Worm Test Details",
        selector: (row) => row.wormTestDetails,
        cell: (row) => <span>{row.wormTestDetails}</span>,
        sortable: true,
        hide: "md",
    },      
  ];
      ...
      <Block.Head>
        <Block.HeadBetween>
          ...
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
                <Link to="/receipt-of-dfls" className="btn btn-primary btn-md d-md-none">
                  <Icon name="plus" />
                  <span>Create</span>
                </Link>
              </li>
