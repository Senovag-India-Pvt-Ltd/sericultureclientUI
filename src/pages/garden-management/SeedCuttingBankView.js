...
function SeedCuttingBankView() {
  ...
  return (
    <Layout title={t("View Seed Cutting Bank Details")}>
      <style>{seedCuttingBankViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">
                {t("View Seed Cutting Bank Details")}
              </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
      ...
      <Block className="mt-n4 sh-view-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="package" />
            <span>{t("Seed Cutting Bank Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
              ...
              <Row className="g-gs">
                <Col lg="12">
                  <DetailGrid
                    items={[
                      { label: t("ID"), value: seedCuttingBank.id },
                      { label: t("Fruits ID"), value: seedCuttingBank.fruitsId },
                      { label: t("Farmer Name"), value: seedCuttingBank.farmerName },
                      { label: t("Quantity Of Seed Cuttings"), value: seedCuttingBank.quantityOfSeedCuttings },
                      { label: t("Date Of Pruning"), value: seedCuttingBank.dateOfPruning },
                      { label: t("Rate Per Tonne"), value: seedCuttingBank.ratePerTonne },
                      { label: t("Receipt Number"), value: seedCuttingBank.receiptNumber },
                      { label: t("Remittance Details"), value: seedCuttingBank.remittanceDetails },
                      {
                        label: t("Uploaded Challan"),
                        value: selectedChallanFile && (
                          <>
                            <img
...
const seedCuttingBankViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
