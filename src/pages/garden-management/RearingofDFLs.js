...
function RearingofDFLs() {
  ...
  return (
    <Layout title={t("Rearing of DFLs")}>
      <style>{rearingOfDFLsFormStyles}</style>
      <Block.Head>
            ...
            <Card.Body>
              ...
              <Col lg="4">
                    <Form.Group className="form-group ">
                      <Form.Label>
                        {t("Disinfectant Usage Details")}<span className="text-danger">*</span>
                      </Form.Label>
                      <Col>
