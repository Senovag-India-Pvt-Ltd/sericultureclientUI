...
function MaintenanceandSaleofNurserytoFarmers() {
  ...
  return (
    <Layout title={t("Maintenance and Sale of Nursery to Farmers")}>
      <style>{maintenanceSaleNurseryFormStyles}</style>
      <Block.Head>
                ...
                <Card.Body>
                  <Row className="g-gs">
                            ...
                            <Form.Group className="form-group mt-n4">
                              ...
                              <div className="form-control-wrap">
                                <Form.Control
                                  ...
                                  onChange={handleInputs}
                                  placeholder={t("Enter Nursery sale details")}
                                />
                              </div>
                            </Form.Group>
                          </Col> */}
                    ...
                    <Col lg="4">
                      <Form.Group className="form-group mt-n4">
                        <Form.Label htmlFor="sordfl">
                          {t("Quantity(No Of Saplings)")}<span className="text-danger">*</span>
                        </Form.Label>
                        <div className="form-control-wrap">
                          <Form.Control
                            id="quantity"
                    ...
                    <Col lg="2">
                      <Form.Group className="form-group mt-n4">
                        <Form.Label htmlFor="sordfl">
                          {t("Sale Date")}<span className="text-danger">*</span>
                        </Form.Label>
                        <div className="form-control-wrap">
                          <DatePicker
                            selected={data.date}
...
const maintenanceSaleNurseryFormStyles = `
  .sh-page-header {
    padding: 20px 24px;
