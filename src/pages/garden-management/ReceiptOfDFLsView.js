...
const getUploadReceipt = async (file) => {
  ...
  return (
    <Layout title={t("View Receipt of DFLs Details")}>
      <style>{receiptOfDFLsViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">
                {t("View Receipt of DFLs Details")}
              </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
      ...
      <Block className="mt-n4 sh-view-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="package" />
            <span>{t("Receipt of DFLs Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
              ...
              <Row className="g-gs">
                <Col lg="12">
                  <DetailGrid
                    items={[
                      { label: t("ID"), value: receiptOfDFLs.id },
                      { label: t("Race Of DFLs"), value: receiptOfDFLs.raceName },
                      { label: t("Grainage"), value: receiptOfDFLs.grainageMasterName },
                      { label: t("Laid On Date"), value: receiptOfDFLs.laidOnDate },
                      { label: t("Hatching Date"), value: receiptOfDFLs.hatchingDate },
                      { label: t("Lot Number"), value: receiptOfDFLs.lotNumber },
                      { label: t("Number Of DFLs Released"), value: receiptOfDFLs.numberOfDflsReleased },
                      { label: t("Invoice Number"), value: receiptOfDFLs.invoiceNumber },
                      {
                        label: t("Uploaded Receipt"),
                        value: selectedUploadReceipt && (
                          <>
                            <img
                              style={{
                                height: "100px",
