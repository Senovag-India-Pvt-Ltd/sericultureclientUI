...
function SeedCuttingBankEdit() {
  ...
  return (
    <Layout title={t("Edit Seed Cutting Bank")}>
      <style>{editSeedCuttingBankStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">
                {t("Edit Seed Cutting Bank")}
              </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
      ...
      <Block className="mt-n4 sh-form-wrap">
        ...
        <Block className="mt-3">
            ...
            <Card.Header className="sh-section-header">
              <Icon name="package" />
              <span>{t("Edit Seed Cutting Bank Details")}</span>
            </Card.Header>
              <Card.Body>
                {loading ? (
...
const editSeedCuttingBankStyles = `
  .sh-page-header {
    padding: 20px 24px;
