...
useEffect(() => {
  ...
  return (
    <Layout title={t("Maintenance of Mulberry Garden")}>
      <style>{maintenanceMulberryGardenFormStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Maintenance of Mulberry Garden")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          ...
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="map-pin" />
              <span>{t("Maintenance of Mulberry Garden")}</span>
            </Card.Header>
            <Card.Body>
...
const maintenanceMulberryGardenFormStyles = `
  .sh-page-header {
    padding: 20px 24px;
