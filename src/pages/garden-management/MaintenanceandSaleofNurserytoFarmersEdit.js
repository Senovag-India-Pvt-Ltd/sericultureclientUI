  ...
  return (
    <Layout title="Maintenance and Sale of Nursery to Farmers ">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">Maintenance and Sale of Nursery to Farmers</Block.Title>
            <nav>
          ...
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
                <Link
                  to="/Maintenance-and-Sale-of-Nursery-to-Farmers"
            ...
            <div  >
              <Row className="g-gs">
                <Col lg="12">
                  <Block >
                    <Card>
                      <Card.Header>Maintenance and Sale of Nursery to Farmers </Card.Header>
                      <Card.Body>
                         <Row className="g-gs">
                        <Col lg="4" >
                      ...
                      Date of planting
                          ...
                          onChange={(date) => handleDateChange(date, "dateOfPlanting")}
                          peekNextMonth
                          showMonthDropdown
                          showYearDropdown
                          dropdownMode="select"
