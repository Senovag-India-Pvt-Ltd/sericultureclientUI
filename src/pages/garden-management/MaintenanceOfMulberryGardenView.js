    ...
    return (
        <Layout title="Maintenance of Mulberry Garden View">
          <Block.Head>
            <Block.HeadBetween>
              <Block.HeadContent>
                <Block.Title tag="h2">Maintenance of Mulberry Garden View</Block.Title>
              </Block.HeadContent>
              <Block.HeadContent>
                <ul className="d-flex">
                  <li>
                ...
                <Col lg="12">
                  <table className="table small table-bordered">
                    ...
                    <tr>
                      ...
                      <tr>
                        <td style={styles.ctstyle}>Fertilizer Application Date:</td>
                      ...
                      <tr>
                        ...
                        <td>{maintenanceGarden.remarks}</td>
                      </tr>
                    </tbody>
                  </table>
                </Col>
