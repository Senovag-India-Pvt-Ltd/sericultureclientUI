  ...
  const downloadFile = async () => {
    if (!workOrderNumber) {
      Swal.fire({
        ...
        html: "<p style='color:#555;font-size:15px;margin:0'>No pre-generated PDF was found for this work order.<br/>Try <b>Generate PDF</b> instead.</p>",
    ...
    try {
      ...
      Swal.fire({
        ...
        html: `<div style="text-align:center"><p style="color:#555;font-size:15px;margin:6px 0 0">Your <b>Work Order PDF</b> has been saved to your device.</p></div>`,
      ...
      <Block className="mt-n4">
        ...
        >
          ...
          <Card.Body style={{ padding: "28px 32px 24px" }}>
            ...
            <div style={{ fontSize: "12px", fontWeight: 700, color: "#1a7a4a", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "18px" }}>
              Step 2 — Select Sanction Order &amp; Download Work Order
            </div>
            ...
            <Row className="align-items-end">
              <Col md={5} style={fieldGroupStyle}>
                ...
                {!workOrderNumber && addressDetails.sanctionOrderNumber && (
                  <small style={{ color: "#e53e3e", fontSize: "12px", marginTop: "4px" }}>
                    No pre-generated work order file found.
                  </small>
                )}
              </Col>
