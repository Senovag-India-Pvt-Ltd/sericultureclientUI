...
function GenerateSelectionLetter() {
  ...
  const downloadFile = async () => {
    ...
    try {
      const fileNameWithExtension = `${workOrderNumber}.pdf`;
  ...
  // ── render ────────────────────────────────────────────────────────
  return (
    <Layout title={t("Selection Letter", { ns: "reports" })}>
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">{t("Selection Letter", { ns: "reports" })}</Block.Title>
          </Block.HeadContent>
        </Block.HeadBetween>
      </Block.Head>
      ...
      <Block className="mt-n4">
        ...
        >
          ...
          >
            ...
            <div>
              <div style={{ color: "#fff", fontWeight: 700, fontSize: "17px", lineHeight: 1.2 }}>
                {t("Selection Letter Filter", { ns: "reports" })}
              </div>
              <div style={{ color: "rgba(255,255,255,0.8)", fontSize: "12px", marginTop: "2px" }}>
                {t("Select filters to load and download Selection Letter", { ns: "reports" })}
              </div>
            </div>
          </div>
          ...
          <Card.Body style={{ padding: "28px 32px 24px" }}>
            ...
            <div style={{ fontSize: "12px", fontWeight: 700, color: "#1a7a4a", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "18px" }}>
              {t("Step 2 — Select Selection Letter & Download", { ns: "reports" })}
            </div>

            {/* Row 4 */}
            <Row className="align-items-end">
              <Col md={5} style={fieldGroupStyle}>
                <label style={labelStyle}>{t("Selection Letter Number", { ns: "reports" })}</label>
                <SearchableSelect
                  ...
                  placeholder={`— ${t("Select Selection Letter", { ns: "reports" })} —`}
              ...
              <Col md={7} className="d-flex gap-3 flex-wrap pb-1">
                <button
                  ...
                  disabled={!workOrderNumber || isDownloading}
                  style={btnStyle(
                    workOrderNumber && !isDownloading,
