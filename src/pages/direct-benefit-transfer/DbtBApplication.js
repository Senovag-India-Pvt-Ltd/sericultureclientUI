...
function DbtBApplication() {
  ...
  const search = (e) => {
    api
      .post(
        baseURLDBT + `service/getDbtBByList`,
        {},
        {
          params: {
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLDBT + `service/dbt-b-list-report`,
        {},
        {
          params: {
            districtId: addressDetails.districtId,
...
return (
  <Layout title={t("DBT B Application Report")}>
    <style>{dbtBApplicationStyles}</style>
    <Block.Head>
      <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("DBT B Application Report")}</Block.Title>
          </Block.HeadContent>
        </Block.HeadBetween>
      </div>
    </Block.Head>
    ...
    <Block className="mt-n4 sh-form-wrap">
      <Card style={{ borderRadius: "12px", border: "none", boxShadow: "0 2px 16px rgba(30,103,168,0.10)", backgroundColor: "#fff" }}>
        <div style={{ background: ACCENT_HEADER, padding: "11px 18px", display: "flex", alignItems: "center", gap: "10px", borderRadius: "12px 12px 0 0" }}>
          ...
          <div>
            <div style={{ color: "#fff", fontWeight: 800, fontSize: "14px" }}>{t("DBT B Application Report")}</div>
            <div style={{ color: "rgba(255,255,255,0.85)", fontSize: "11px" }}>{t("Select filters to search and export B application data")}</div>
          </div>
        </div>
...
export default DbtBApplication;
