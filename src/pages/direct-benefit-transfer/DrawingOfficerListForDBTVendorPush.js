...
function DrawingOfficerListForDBTVendorPush() {
...
const [showCheckboxes, setShowCheckboxes] = useState(false);
  ...
  api
    .post(
      baseURLDBT + `service/getVendorListForDBTPush`,
      {},
      {
        params: {
          userMasterId: localStorage.getItem("userMasterId"),
...
// }
  ...
  const drawingOfficerListForDBTVendorPushStyles = `
    .sh-page-header {
      padding: 20px 24px;
...
export default DrawingOfficerListForDBTVendorPush;
