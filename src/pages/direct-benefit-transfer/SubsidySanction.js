...
function SubsidySanction() {
  ...
  return (
    <Layout title="Subsidy Sanction List">
      <style>{subsidySanctionStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("Subsidy Sanction List")}</Block.Title>
            <nav>
              <ol className="breadcrumb breadcrumb-arrow mb-0">
                <li className="breadcrumb-item">
                  <Link to="/seriui/">{t("Home")}</Link>
                </li>
                {/* <li className="breadcrumb-item"><Link to="/seriui/crm/case-task">Subsidy Sanction List</Link></li> */}
...
export default SubsidySanction;
