...
function DbtSuccessApplication() {
  ...
  <Layout title="DBT Success Application Report">
    <Block.Head>
      <Block.HeadBetween>
        <Block.HeadContent>
          <Block.Title tag="h2">
            {t("DBT Success Application Report")}
          </Block.Title>
        </Block.HeadContent>
      </Block.HeadBetween>
    </Block.Head>
    ...
    <Block className="mt-n4">
      <Card className="mt-1">
        {/* ✅ Changed layout from flex-column to two rows like first snippet */}
        <Row className="m-4">
          {/* Search By */}
          <Col sm={3}>
...
export default DbtSuccessApplication;
