...
function SubsidyDrawing() {
  ...
  return (
    <Layout title="Subsidy Drawing List">
      <style>{subsidyDrawingStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("Subsidy Drawing List")}</Block.Title>
            <nav>
