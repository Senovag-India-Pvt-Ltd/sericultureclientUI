...
const drawingOfficerListStyles = `
  .sh-page-header {
    padding: 20px 24px;
  ...
  .sh-cancel-btn:hover:not(:disabled) { background: linear-gradient(135deg, #e3496a 0%, #c43257 100%); color: #ffffff; border-color: transparent; }
...
const getFinancialDefaultDetails = () => {
  ...
  return (
    <Layout title="Drawing Officer List">
      <style>{drawingOfficerListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("Drawing Officer List")}</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            {/* <ul className="d-flex">
              <li>
