...
function DrawingOfficerListForK2VendorPush() {
...
const [showCheckboxes, setShowCheckboxes] = useState(false);
  ...
  api
    .post(
      baseURLDBT + `service/getVendorListForK2Push`,
      {},
      {
        params: {
          userMasterId: localStorage.getItem("userMasterId"),
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLDBT + `service/getVendorListForK2PushReport`,
        {},
        {
          params: {
            userMasterId: localStorage.getItem("userMasterId"),
      ...
      .then((response) => {
        ...
        link.download = `vendor_list_for_k2_push_report.csv`;
...
// }
  ...
  const drawingOfficerListForK2VendorPushStyles = `
    .sh-page-header {
      padding: 20px 24px;
...
export default DrawingOfficerListForK2VendorPush;
