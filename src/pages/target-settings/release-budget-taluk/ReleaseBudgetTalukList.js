...
function ReleaseBudgetTalukList() {
  ...
  return (
    <Layout title="Released taluk budget list">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">Released Taluk Budget List</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
      ...
      <Form noValidate validated={validated} onSubmit={postData}>
          <Row className="g-3 ">
            <Block>
              <Card>
                <Card.Header>List Of Taluk Budget</Card.Header>
                <Card.Body>
...
export default ReleaseBudgetTalukList;
