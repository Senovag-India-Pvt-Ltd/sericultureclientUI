...
function BudgetTscExtensionView() {
  const styles = {
    ctstyle: {
  ...
  return (
    <Layout title="View Institution Budget mapping scheme and programs">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">
              View Institution Budget mapping scheme and programs
            </Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
                <Link
                  to="/seriui/budgettscextension-list"
      ...
      <Block className="mt-n4">
        <Card>
          <Card.Header>
            Institution Budget mapping scheme and programs View Details
          </Card.Header>
          <Card.Body>
            {loading ? (
                ...
                <Col lg="12">
                  <table className="table small table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td style={styles.ctstyle}>Institution:</td>
                        <td>
                          <span>{budgetDistrictData.institution}</span>
                        </td>
                      </tr>
                      <tr>
...
export default BudgetTscExtensionView;
