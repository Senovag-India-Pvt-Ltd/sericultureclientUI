...
function BudgetTscExtensionList() {
  ...
  const handleView = (id) => {
    navigate(`/seriui/budgettscextension-view/${id}`);
  };

  const handleEdit = (id) => {
    navigate(`/seriui/budgettscextension-edit/${id}`);
  };
...
export default BudgetTscExtensionList;
