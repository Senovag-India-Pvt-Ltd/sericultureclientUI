...
function FinancialTargetSettingEdit() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      event.preventDefault();
      api
        .post(baseURL + `tsFinancialTargetSetting/edit`, data)
        .then((response) => {
  ...
  const getIdList = () => {
    setLoading(true);
    const response = api
      .get(baseURL + `tsFinancialTargetSetting/get/${id}`)
      .then((response) => {
...
export default FinancialTargetSettingEdit;
