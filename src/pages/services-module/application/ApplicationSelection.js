...
const applicationSelectionStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
function ApplicationSelection() {
  ...
  return (
    <Layout title="Application Selection List">
      <style>{applicationSelectionStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">Application Selection List</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
      ...
      <div className="gap-col mt-1">
        <ul className="d-flex align-items-center justify-content-center gap g-3">
          <li>
            <Button type="submit" className="sh-save-btn" onClick={postData}>
              Save
            </Button>
          </li>
          <li>
            <Button type="button" className="sh-cancel-btn" onClick={(e) => clear(e)}>
              Cancel
            </Button>
          </li>
        </ul>
