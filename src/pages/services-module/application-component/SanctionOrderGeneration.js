...
const sanctionOrderGenerationStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
const SanctionOrderGeneration = () => {
  ...
  return (
    <div>
      <style>{sanctionOrderGenerationStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">Sanction Order Generation List</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
