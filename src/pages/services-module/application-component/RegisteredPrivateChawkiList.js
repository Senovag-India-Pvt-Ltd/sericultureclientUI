...
//   };
  ...
  return (
    <Layout title="List of Registered Private Bivoltine Chawki Rearing Center Subsidy">
      <style>{registeredPrivateChawkiListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">List of Registered Private Bivoltine Chawki Rearing Center Subsidy</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const registeredPrivateChawkiListStyles = `
  .sh-page-header {
    padding: 20px 24px;
