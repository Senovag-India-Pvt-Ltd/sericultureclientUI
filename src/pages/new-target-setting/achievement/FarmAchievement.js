...
const handleShowModal = () => {
 ...
 return (
  <Layout title={t("Farm Wise Achievement")}>
    <style>{farmAchievementStyles}</style>
    <Block.Head>
      <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("Farm Wise Achievement")}</Block.Title>
          </Block.HeadContent>
                ...
                <Block>
                  <Card className="sh-section-card">
                    <Card.Header className="sh-section-header">
                      ...
                      <span>{t("Farm Wise Achievement")}</span>
                    </Card.Header>
                    <Card.Body>
                    {/* <div
                      style={{
