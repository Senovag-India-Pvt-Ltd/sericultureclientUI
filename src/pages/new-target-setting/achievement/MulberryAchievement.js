 ...
 useEffect(() => {
  ...
  <Layout title={t("Mulberry Wise Achievement")}>
    <Block.Head>
      <Block.HeadBetween>
        <Block.HeadContent>
          <Block.Title tag="h2">{t("Mulberry Wise Achievement")}</Block.Title>
        </Block.HeadContent>
          ...
          <Col lg="12">
            <Form noValidate validated={validated} onSubmit={postData}>
              <Row className="g-3 ">
                <Block>
                  <Card>
                    <Card.Header>{t("Mulberry Wise Achievement")} </Card.Header>
    ...
    <div className="form-control-wrap">
      ...
      <Modal show={showModal3} onHide={handleCloseModal3} size="xl">
        <Modal.Header closeButton>
          <Modal.Title>{t("Mulberry Wise Achievement")}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {/* <Form action="#"> */}
          <Form
