...
useEffect(() => {
  ...
  return (
  <Layout title={t("Physical Wise Achievement Page")}>
    <style>{physicalAchivementStyles}</style>
    <Block.Head>
      <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">
              {t("Physical Wise Achievement Page")}
            </Block.Title>
          </Block.HeadContent>
          {/* Removed View Target button here */}
        </Block.HeadBetween>
      </div>
    </Block.Head>
                ...
                <Block>
                  <Card className="sh-section-card">
                    <Card.Header className="sh-section-header">
                      ...
                      <span>{t("Physical Wise Achievement Page")}</span>
                    </Card.Header>
...
const physicalAchivementStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default PhysicalAchievement;
