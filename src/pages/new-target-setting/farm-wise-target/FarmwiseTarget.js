...
const handleShowModal = () => {
  ...
  return (
    <Layout title={t("Farm Wise Target Setting Page")}>
      <style>{farmwiseTargetStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Farm Wise Target Setting Page")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
              ...
              <Row className="g-3 ">
                <Block>
                  <Card className="sh-section-card">
                    <Card.Header className="sh-section-header">
                      ...
                      <span>{t("Farm Wise Target Setting Page")}</span>
                    </Card.Header>
                    <Card.Body>
                    <div
                      style={{
                          ...
                          <thead>
                            <tr>
                              <th style={styles.ctstyle}>
                                ...
                                {formatQty(viewTotalTargetsDataBrushing[0]?.yearlyFarmValue) ?? t("N/A")}
                              </th>
                            </tr>
                          </thead>
                        </table>
                          ...
                          <thead>
                            <tr>
                              <th style={styles.ctstyle}>
                                ...
                                {formatQty(viewTotalTargetsDataCocoonProduction[0]?.yearlyFarmValue) ?? t("N/A")}
                              </th>
                            </tr>
                          </thead>
                        </table>
                          ...
                          <thead>
                            <tr>
                              <th style={styles.ctstyle}>
                                ...
                                {!isNaN(parseFloat(viewTotalTargetsDataCocoonProduction[0]?.yearlyFarmValue)) && !isNaN(parseFloat(viewTotalTargetsDataBrushing[0]?.yearlyFarmValue)) ? formatQty((parseFloat(viewTotalTargetsDataCocoonProduction[0]?.yearlyFarmValue))+(parseFloat(viewTotalTargetsDataBrushing[0]?.yearlyFarmValue))):t("N/A") ||
                                  t("N/A")}
                              </th>
                            </tr>
                          </thead>
                ...
                <Block>
                  <Card className="sh-section-card">
                    ...
                    <Card.Body>
                      {/* Weekly target entry — 4 weeks per month for both Brushing and
                          Cocoon Production; the monthly total auto-sums from the four
                          weekly values (see setWeekValue). */}
                      <Row className="g-gs">
                        {FARM_MONTHS.map((m) => {
                          ...
                          return (
                            <Col lg="6" key={m}>
                              <Form.Group className="form-group mt-n2">
                                <Form.Label className="bold fs-5">{t(label)}</Form.Label>
                                <Row className="g-gs">
                                  <Col lg="6">
                                    <Form.Label>
                                      {t("Brushing")}{" "}
                                      <span className="text-muted">
                                        ({t("Total")}: {brushingMonth[m] || 0})
                                      </span>
                                    </Form.Label>
                                    <Row className="g-1">
                                      {[1, 2, 3, 4].map((wk) => (
                                        <Col xs="3" key={wk}>
                                          <Form.Control
                                            name={`${m}_brushing_week${wk}`}
                                            value={brushingWeeks[wk - 1][m] || ""}
                                            onChange={(e) =>
                                              setWeekValue("brushing", wk - 1, m, e.target.value)
                                            }
                                            type="number"
                                            step="0.00001"
                                            min="0"
                                  ...
                                  <Col lg="6">
                                    <Form.Label>
                                      {t("Cocoon Production")}{" "}
                                      <span className="text-muted">
                                        ({t("Total")}: {cocoonProductionMonth[m] || 0})
                                      </span>
                                    </Form.Label>
                                    <Row className="g-1">
                                      {[1, 2, 3, 4].map((wk) => (
                                        <Col xs="3" key={wk}>
                                          <Form.Control
                                            name={`${m}_cocoon_week${wk}`}
                                            value={cocoonWeeks[wk - 1][m] || ""}
                                            onChange={(e) =>
                                              setWeekValue("cocoon", wk - 1, m, e.target.value)
                                            }
                                            type="number"
                                            step="0.00001"
                                            min="0"
      ...
      <Modal show={showModal3} onHide={handleCloseModal3} size="xl" className="sh-modal">
        <Modal.Header closeButton className="sh-modal-header">
          <Modal.Title>
            <Icon name="edit" />
            <span>{t("Farm Wise Target Setting")}</span>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {/* <Form action="#"> */}
