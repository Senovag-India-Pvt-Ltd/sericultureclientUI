...
useEffect(() => {
  ...
  return (
    <Layout title={t("District Wise Physical Target Setting")}>
      <style>{districtwiseProductionPhysicalTargetSettingStyles}</style>
      <Block.Head>
                ...
                <Block>
                  <Card className="sh-section-card">
                    <Card.Header className="sh-section-header">
                      ...
                      <span>{t("District Wise Physical Target Setting")}</span>
                    </Card.Header>
                    <div
                      style={{
                        display: 'flex',
...
/>
      ...
      <Modal show={showModal4} onHide={handleCloseModal4} size="xl" style={{ maxWidth: '100%', margin: '0 auto' }} className="sh-modal">
...
const districtwiseProductionPhysicalTargetSettingStyles = `
  .sh-page-header {
    padding: 20px 24px;
