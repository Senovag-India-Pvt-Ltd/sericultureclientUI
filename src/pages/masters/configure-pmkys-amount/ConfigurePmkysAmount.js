...
function ConfigurePmkysAmount() {
  ...
  return (
    <Layout title="Configure Amount">
      <style>{configurePmkysAmountStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">Configure Amount</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="setting" />
                <span>Configure Amount Details</span>
              </Card.Header>
              <Card.Body>
...
const configurePmkysAmountStyles = `
  .sh-page-header {
    padding: 20px 24px;
