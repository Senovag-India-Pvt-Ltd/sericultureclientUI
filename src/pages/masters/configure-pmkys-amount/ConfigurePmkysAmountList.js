...
//   };
  ...
  return (
    <Layout title="List of Configured Amount">
      <style>{configurePmkysAmountListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">List of Configured Amount</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const configurePmkysAmountListStyles = `
  .sh-page-header {
    padding: 20px 24px;
