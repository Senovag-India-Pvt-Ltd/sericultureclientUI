...
import UnitOfMeasurementsData, {
  unitOfMeasurementColumns,
} from "../../../store/masters/unitOfMeasurement/UnitOfMeasurementData";
          ...
          <Block.HeadContent>
            ...
            <nav>
              <ol className="breadcrumb breadcrumb-arrow mb-0">
                ...
                <li className="breadcrumb-item">
                  <Link to="/seriui/masters/unit-of-measurements">
                    UoM list
                  </Link>
                </li>
      ...
      <Block>
        <Card>
          <DataTable
            ...
            data={UnitOfMeasurementsData}
            columns={unitOfMeasurementColumns}
          />
        </Card>
      </Block>
