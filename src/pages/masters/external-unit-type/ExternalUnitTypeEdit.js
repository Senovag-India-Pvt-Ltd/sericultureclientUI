...
const handleInputs = (e) => {
  ...
  return (
    <Layout title={t("Edit External Unit Type")}>
      <style>{externalUnitTypeEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit External Unit Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const externalUnitTypeEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
