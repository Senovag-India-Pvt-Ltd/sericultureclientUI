...
const handleInputs = (e) => {
  ...
  return (
    <Layout title={t("External Unit Type")}>
      <style>{externalUnitTypeStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("External Unit Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="setting" />
                <span>{t("External Unit Type Details")}</span>
              </Card.Header>
              <Card.Body>
...
export default ExternalUnitType;