...
function RaceMappingView() {
  ...
  return (
    <Layout title={t("Race Mapping View")}>
      <style>{raceMappingViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Race Mapping View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Race Mapping Details")}</span>
          </Card.Header>
          <Card.Body>
            <Row className="g-gs">
              <Col lg="12">
...
export default RaceMappingView;
