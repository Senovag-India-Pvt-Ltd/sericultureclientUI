...
function PlantationTypeEdit() {
  ...
  return (
    <Layout title="Edit Plantation Type">
      <style>{plantationTypeEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Plantation Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Plantation Type")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const plantationTypeEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default PlantationTypeEdit;
