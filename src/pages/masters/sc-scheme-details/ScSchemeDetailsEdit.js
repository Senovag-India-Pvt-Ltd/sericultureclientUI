...
function ScSchemeDetailsEdit() {
  ...
  return (
    <Layout title="Edit Scheme Details">
      <style>{scSchemeDetailsEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Scheme Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Scheme Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
        ...
        <DbtCodeFinancialYearPanel masterType="SC_SCHEME_DETAILS" parentId={id} />
      </Block>
    </Layout>
  );
}

const scSchemeDetailsEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
