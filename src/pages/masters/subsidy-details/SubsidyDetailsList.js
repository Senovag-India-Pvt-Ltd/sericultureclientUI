...
function SubsidyDetailsList() {
  ...
  return (
    <Layout title="Rearing Equipment Details List">
      <style>{subsidyDetailsListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title"> {t("Rearing Equipment Details List")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const subsidyDetailsListStyles = `
  .sh-page-header {
    padding: 20px 24px;
