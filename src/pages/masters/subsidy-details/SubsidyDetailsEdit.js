...
function SubsidyDetailsEdit() {
  ...
  return (
    <Layout title="Edit Rearing Equipment Details">
      <style>{subsidyDetailsEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Rearing Equipment Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Rearing Equipment Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const subsidyDetailsEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
