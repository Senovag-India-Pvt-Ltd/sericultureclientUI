...
function RelationshipEdit() {
  ...
  const postData = (event) => {
    const datas = {
      ...
      relationshipNameInKannada: data.relationshipNameInKannada,
    };
  ...
  return (
    <Layout title="Relationship">
      <style>{relationshipEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("relationship")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
