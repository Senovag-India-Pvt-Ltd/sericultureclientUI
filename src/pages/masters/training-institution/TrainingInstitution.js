...
function TrainingInstitution() {
  ...
  return (
    <Layout title="Training Institution">
      <style>{trainingInstitutionStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Training Institution")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const trainingInstitutionStyles = `
  .sh-page-header {
    padding: 20px 24px;
