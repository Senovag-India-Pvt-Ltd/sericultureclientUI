...
function TrainingInstitutionEdit() {
  ...
  return (
    <Layout title="Edit Training Institution">
      <style>{trainingInstitutionEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Training Institution")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const trainingInstitutionEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
