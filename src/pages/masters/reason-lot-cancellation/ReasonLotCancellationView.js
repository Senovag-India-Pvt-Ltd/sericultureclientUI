...
function ReasonLotCancellationView() {
  ...
  return (
    <Layout title={t("Reason for Lot Cancellation View")}>
      <style>{reasonLotCancellationViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Reason for Lot Cancellation View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const reasonLotCancellationViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
