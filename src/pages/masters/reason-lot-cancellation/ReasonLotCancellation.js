...
function ReasonLotCancellation() {
  ...
  return (
    <Layout title={t("Reason for Lot Cancellation")}> {/* Add translation function */}
      <style>{reasonLotCancellationStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Reason for Lot Cancellation")}</Block.Title> {/* Add translation function */}
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const reasonLotCancellationStyles = `
  .sh-page-header {
    padding: 20px 24px;
