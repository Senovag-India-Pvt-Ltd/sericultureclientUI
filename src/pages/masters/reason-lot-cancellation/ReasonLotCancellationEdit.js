...
function ReasonLotCancellationEdit() {
  ...
  return (
    <Layout title={t("Edit Reason for Lot Cancellation")}> {/* Add translation function */}
      <style>{reasonLotCancellationEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Reason for Lot Cancellation")}</Block.Title> {/* Add translation function */}
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Reason for Lot Cancellation Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const reasonLotCancellationEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default ReasonLotCancellationEdit;
