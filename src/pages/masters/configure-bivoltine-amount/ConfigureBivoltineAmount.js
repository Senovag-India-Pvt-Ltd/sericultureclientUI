...
function ConfigureBivoltineAmount() {
  ...
  return (
    <Layout title="Configure Bonus Amount">
      <style>{configureBivoltineAmountStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">Configure Bonus Amount</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="setting" />
                <span>Configure Bonus Amount Details</span>
              </Card.Header>
              <Card.Body>
...
const configureBivoltineAmountStyles = `
  .sh-page-header {
    padding: 20px 24px;
