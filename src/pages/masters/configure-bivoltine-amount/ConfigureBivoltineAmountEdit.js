...
function ConfigureBivoltineAmountEdit() {
  ...
  return (
    <Layout title="Edit Configured Bonus Amount">
      <style>{configureBivoltineAmountEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">Edit Configured Bonus Amount</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>Edit Configured Bonus Amount Details</span>
              </Card.Header>
              <Card.Body>
...
const configureBivoltineAmountEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
