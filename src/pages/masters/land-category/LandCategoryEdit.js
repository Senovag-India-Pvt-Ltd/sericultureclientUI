...
function LandCategoryEdit() {
  ...
  const postData = (event) => {
    const datas = {
      id: id,
      landCategoryName: data.landCategoryName,
      landCategoryNameInKannada: data.landCategoryNameInKannada,
    };
  ...
  return (
    <Layout title="Edit Land Category">
      <style>{landCategoryEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Land Category")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Land Category")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
export default LandCategoryEdit;
