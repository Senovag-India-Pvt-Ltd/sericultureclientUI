...
import BankDetailsData, { bankDetailsColumns } from '../../../store/masters/accounts/BankDetailsData';
...
function BankDetailsListPage() {
  ...
  return (
    <Layout title="Bank Details List" content="container">
                ...
                <Block.HeadContent>
                    ...
                    <nav>
                        <ol className="breadcrumb breadcrumb-arrow mb-0">
                          ...
                          <li className="breadcrumb-item"><Link to="/masters/bank-details">Bank Details list</Link></li>
      ...
      <Block>
        <Card>
          <DataTable tableClassName="data-table-head-light table-responsive" data={BankDetailsData} columns={bankDetailsColumns}/>
        </Card>
      </Block>
              ...
              <Row className="g-3">
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="bankName" type="text" placeholder="Enter Bank Name"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="accountName" type="text" placeholder="Enter Account Name"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="AccNumber" type="text" placeholder="Enter Account Number"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="branch" type="text" placeholder="Enter Branch Name"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="ifsc" type="text" placeholder="Enter IFSC code"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="address" type="text" placeholder="Enter Bank Address"/>
                          </div>
                      </Form.Group>
                  </Col>
