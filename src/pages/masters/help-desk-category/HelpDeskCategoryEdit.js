...
function HelpDeskCategoryEdit() {
  ...
  return (
    <Layout title="Edit Category">
      <style>{helpDeskCategoryEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Category")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const helpDeskCategoryEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
