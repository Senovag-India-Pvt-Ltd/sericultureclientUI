...
const { t } = useTranslation();
  ...
  const postData = (event) => {
    const datas = {
      ...
      grainageAreaType: data.grainageAreaType,
  ...
  return (
    <Layout title={t("Edit Grainage")}>
      <style>{grainageEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Grainage")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
