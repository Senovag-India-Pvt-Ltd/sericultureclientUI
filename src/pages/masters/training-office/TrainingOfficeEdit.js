...
function TrainingOfficeEdit() {
  ...
  return (
    <Layout title="Edit Training Office">
      <style>{trainingOfficeEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Training Office")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const trainingOfficeEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default TrainingOfficeEdit;
