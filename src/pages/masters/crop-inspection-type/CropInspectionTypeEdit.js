...
function CropInspectionTypeEdit() {
  ...
  return (
 <Layout title={t('Edit Crop Inspection Type')}>
  <style>{cropInspectionTypeEditStyles}</style>
  <Block.Head>
    <div className="sh-page-header">
    <Block.HeadBetween>
      <Block.HeadContent>
        <Block.Title tag="h2" className="sh-page-title">{t('Edit Crop Inspection Type')}</Block.Title>
      </Block.HeadContent>
      <Block.HeadContent>
        <ul className="d-flex">
          <li>
...
const cropInspectionTypeEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
