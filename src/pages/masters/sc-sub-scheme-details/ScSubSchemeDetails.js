...
function ScSubSchemeDetails() {
  ...
  return (
    <Layout title="Component Type">
      <style>{scSubSchemeDetailsStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Component Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="setting" />
                <span>{t("Component Type Details")}</span>
              </Card.Header>
              <Card.Body>
...
const scSubSchemeDetailsStyles = `
  .sh-page-header {
    padding: 20px 24px;
