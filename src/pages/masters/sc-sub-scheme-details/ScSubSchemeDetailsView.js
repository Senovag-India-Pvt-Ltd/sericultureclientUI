...
function ScSubSchemeDetailsView() {
  ...
  return (
    <Layout title="View Component Type Details">
      <style>{scSubSchemeDetailsViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Component Type Details")} </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("View Component Type Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
...
const scSubSchemeDetailsViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
