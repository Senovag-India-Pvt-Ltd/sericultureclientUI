...
function ScSubSchemeDetailsList() {
  ...
  return (
    <Layout title="List Of Component Type">
      <style>{scSubSchemeDetailsListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("List Of Component Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const scSubSchemeDetailsListStyles = `
  .sh-page-header {
    padding: 20px 24px;
