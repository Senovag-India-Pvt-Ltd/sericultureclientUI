...
function HelpDeskSeverityEdit() {
  ...
  return (
    <Layout title="Edit Help Desk Severity">
      <style>{helpDeskSeverityEditStyles}</style>
      <Block.Head>
...
const helpDeskSeverityEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default HelpDeskSeverityEdit;
