...
function ConfigureReelingShedEdit() {
  ...
  return (
    <Layout title={t("Edit Configure Reeling Shed/Adopting Silent Generator/Adopting Solar power Generator/Adopting Solar Water Heater")}>
      <style>{configureReelingShedEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Configure Reeling Shed/Adopting Silent Generator/Adopting Solar power Generator/Adopting Solar Water Heater")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Configure Reeling Shed Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const configureReelingShedEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
