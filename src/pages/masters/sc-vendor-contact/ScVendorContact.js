...
function ScVendorContact() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      event.preventDefault();
      api
        .post(baseURL + `scVendorContact/add`, data)
        .then((response) => {
  ...
  return (
    <Layout title="Vendor Contact">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">Vendor Contact</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
...
export default ScVendorContact;
