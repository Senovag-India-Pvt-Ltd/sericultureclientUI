...
function MulberryVariety() {
  ...
  return (
    <Layout title="Mulberry Variety">
      <style>{mulberryVarietyStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Mulberry Variety")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="package" />
                <span>{t("Mulberry Variety Details")}</span>
              </Card.Header>
              <Card.Body>
...
export default MulberryVariety;
