...
function MulberryVarietyEdit() {
  ...
  return (
    <Layout title="Edit Mulberry Variety">
      <style>{mulberryVarietyEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Mulberry Variety")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Mulberry Variety")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const mulberryVarietyEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default MulberryVarietyEdit;
