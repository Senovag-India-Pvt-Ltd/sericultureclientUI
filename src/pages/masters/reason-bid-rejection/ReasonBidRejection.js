...
function ReasonBidRejection() {
  ...
  const postData = (e) => {
    axios
      .post(baseURL + `reason-bid-reject-master/add`, data, {
        headers: _header,
      })
      .then((response) => {
        saveSuccess();
  ...
  return (
    <Layout title="Reason for Bid Rejection" content="container">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">Reason for Bid Rejection</Block.Title>
            <nav>
...
export default ReasonBidRejection;
