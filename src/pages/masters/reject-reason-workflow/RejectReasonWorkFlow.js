...
function RejectReasonWorkFlowMaster() {
  ...
  return (
    <Layout title="Reject Reason Work Flow">
      <style>{rejectReasonWorkFlowStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Reject Reason Work Flow")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card className="sh-section-card">
              <Card.Header className="sh-section-header">
                ...
                <span>{t("Reject Reason Work Flow")}</span>
              </Card.Header>
              <Card.Body>
...
const rejectReasonWorkFlowStyles = `
  .sh-page-header {
    padding: 20px 24px;
