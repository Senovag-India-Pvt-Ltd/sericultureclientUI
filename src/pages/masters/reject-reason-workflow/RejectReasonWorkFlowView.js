...
function RejectReasonWorkFlowView() {
  ...
  return (
    <Layout title="View Reject Reason Work Flow ">
      <style>{rejectReasonWorkFlowViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Reject Reason Work Flow")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Reject Reason Work Flow Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
                  ...
                  <table className="table small table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{rejectReasonWorkFlow.reason ? t(rejectReasonWorkFlow.reason) : rejectReasonWorkFlow.reason}</td>
                      </tr>
...
const rejectReasonWorkFlowViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
