...
function ConfigureRHUnitPriceAmount() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURLDBT + `configureRHAmount/add`, data)
        .then((response) => {
  ...
  return (
    <Layout title="Configure Unit Price Amount For RH">
      <style>{configureUnitPriceRHStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">Configure Unit Price Amount For RH</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="setting" />
                <span>Configure Unit Price Amount For RH Details</span>
              </Card.Header>
              <Card.Body>
...
const configureUnitPriceRHStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default ConfigureRHUnitPriceAmount;
