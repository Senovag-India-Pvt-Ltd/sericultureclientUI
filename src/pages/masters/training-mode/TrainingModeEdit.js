...
function TrainingModeEdit() {
  ...
  return (
    <Layout title="Edit Training Mode">
      <style>{trainingModeEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Training Mode")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
export default TrainingModeEdit;
