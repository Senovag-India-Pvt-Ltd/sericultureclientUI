...
function WormStageList() {
  ...
  const WormStageDataColumns = [
    ...
    {
      name: t("Worm Stage Name in Kannada"),
  ...
  return (
    <Layout title={t("List Of Worm Stage")}>
      <style>{wormStageListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("List Of Worm Stage")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
