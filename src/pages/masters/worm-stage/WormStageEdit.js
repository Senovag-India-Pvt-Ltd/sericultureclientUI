...
function WormStageEdit() {
  ...
  return (
    <Layout title={t("Edit Worm Stage")}>
      <style>{wormStageEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Worm Stage")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Worm Stage Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
