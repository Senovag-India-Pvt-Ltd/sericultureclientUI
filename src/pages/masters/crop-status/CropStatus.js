...
function CropStatus() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURL + `cropStatus/add`, data)
        .then((response) => {
...
<Layout title="Crop Status">
  <style>{cropStatusStyles}</style>
  <Block.Head>
    <div className="sh-page-header">
      <Block.HeadBetween>
        <Block.HeadContent>
          <Block.Title tag="h2" className="sh-page-title">{t('Crop Status')}</Block.Title>
        </Block.HeadContent>
        <Block.HeadContent>
          <ul className="d-flex">
            <li>
              ...
              <Col lg="6">
                <Form.Group className="form-group">
                  <Form.Label htmlFor="name">
                    {t('Crop Status')} <span className="text-danger">*</span>
                  </Form.Label>
                  <div className="form-control-wrap">
                    <Form.Control
                      ...
                      type="text"
                      placeholder={t('Enter Crop Status Name')}
                      required
                    />
