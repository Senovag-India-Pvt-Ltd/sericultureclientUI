...
function RearHouseRoofTypeEdit() {
  ...
  return (
    <Layout title="Edit Rear House Roof Type">
      <style>{rearHouseRoofTypeEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Rear House Roof Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Rear House Roof Type")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const rearHouseRoofTypeEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default RearHouseRoofTypeEdit;
