...
//   }, []);
  ...
  return (
    <Layout title="Edit Dbt Status Check">
      <style>{dbtStatusCheckEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Dbt Status Check")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
                ...
                <Row className="g-3 ">
                  <Card>
                    <Card.Header className="sh-section-header">
                      <Icon name="edit" />
                      <span>{t("Edit Dbt Status Check Details")}</span>
                    </Card.Header>
                    <Card.Body>
                      {loading ? (
...
const dbtStatusCheckEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
