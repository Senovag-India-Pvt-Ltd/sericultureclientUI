...
function ConfigureImcbView() {
  ...
  return (
    <Layout title={t("Configure Imcb View")} content="container">
      <style>{configureImcbViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Configure Imcb View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Configure imcb Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
