...
function HelpDeskBoardCategoryView() {
  ...
  return (
    <Layout title="Broad Category View">
      <style>{helpDeskBoardCategoryViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Broad Category View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const helpDeskBoardCategoryViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
