...
function FarmerBankAccountReasonView() {
  ...
  const getIdList = () => {
    ...
    const response = api
      ...
      .then((response) => {
        setReason(response.data.content);
        setLoading(false);
      })
      .catch((err) => {
        setReason({});
    ...
    <Layout title="Farmer Bank Reason View" content="container">
      ...
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Farmer Bank Reason View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const farmerBankAccountReasonViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default FarmerBankAccountReasonView;
