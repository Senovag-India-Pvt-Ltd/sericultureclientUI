...
function FarmerBankAccountReasonEdit() {
  // Translation
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURL + `farmerBankAccountReason/edit`,{...data,farmerBankAccountReasonId:id})
        .then((response) => {
  ...
  const getIdList = () => {
    setLoading(true);
    const response = api
      .get(baseURL + `farmerBankAccountReason/get/${id}`)
      .then((response) => {
  ...
  return (
    <Layout title="Edit Farmer Bank Account Reason">
      <style>{farmerBankAccountReasonEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Farmer Bank Account Reason")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
                  <Link
                    to="/seriui/farmerBankAccountReason-list"
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Farmer Bank Account Reason")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
                  ...
                  <Row className="g-gs">
                    <Col lg="6">
                      <Form.Group className="form-group">
                        ...
                        {t("Farmer Bank Account Reason")}<span className="text-danger">*</span>
                        </Form.Label>
                        <div className="form-control-wrap">
                          <Form.Control
                            id="farmerBankAccountReason"
                            name="farmerBankAccountReason"
...
const farmerBankAccountReasonEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default FarmerBankAccountReasonEdit;
