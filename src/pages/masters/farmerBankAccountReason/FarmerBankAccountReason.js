...
function FarmerBankAccountReason() {
 ...
 const { t } = useTranslation();
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURL + `farmerBankAccountReason/add`, data)
        .then((response) => {
  ...
  return (
    <Layout title="Farmer Bank Account Reason">
      <style>{farmerBankAccountReasonStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Farmer Bank Account Reason")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="book" />
                <span>{t("Farmer Bank Account Reason Details")}</span>
              </Card.Header>
              <Card.Body>
...
const farmerBankAccountReasonStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default FarmerBankAccountReason;
