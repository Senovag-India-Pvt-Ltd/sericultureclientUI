...
function ScHeadAccountCategory() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURL + `scHeadAccountCategory/add`, data)
        .then((response) => {
  ...
  return (
    <Layout title=" Head Account Category">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2"> Head Account Category</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
...
export default ScHeadAccountCategory;
