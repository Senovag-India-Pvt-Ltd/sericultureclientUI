...
function DivisionMasterView() {
  ...
  return (
    <Layout title={t("Division View")}> {/* Modify this line */}
      <style>{divisionMasterViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Division View")}</Block.Title> {/* Modify this line */}
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Division Details")}</span>
          </Card.Header> {/* Modify this line */}
          <Card.Body>
            {loading ? (
...
const divisionMasterViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
