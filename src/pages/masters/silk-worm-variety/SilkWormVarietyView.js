...
function SilkWormVarietyView() {
  ...
  return (
    <Layout title="Silk Worm Variety View">
      <style>{silkWormVarietyViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Silk Worm Variety View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Silk Worm Variety Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
                ...
                <Col lg="12">
                  <table className="table small table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td style={styles.ctstyle}> {t("Silk Worm Variety")}</td>
...
const silkWormVarietyViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
