...
function SilkWormVarietyEdit() {
  ...
  return (
    <Layout title="Edit Silk Worm Variety">
      <style>{silkWormVarietyEditStyles}</style>
      <Block.Head>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Silk Worm Variety")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const silkWormVarietyEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default SilkWormVarietyEdit;
