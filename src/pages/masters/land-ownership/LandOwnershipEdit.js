...
function LandOwnershipEdit() {
  ...
  return (
    <Layout title="Edit Land Ownership">
      <style>{landOwnershipEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Land Ownership")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Land Ownership")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
