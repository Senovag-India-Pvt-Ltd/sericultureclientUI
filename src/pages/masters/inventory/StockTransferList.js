...
import StockTransfer, { stockTransferColumns } from '../../../store/masters/inventory/StockTransferData';
...
function StockTransferPage() {
    ...
    return (
        <Layout title="Stock Transfer" content="container">
                    ...
                    <Block.HeadContent>
                        ...
                        <nav>
                            <ol className="breadcrumb breadcrumb-arrow mb-0">
                                ...
                                <li className="breadcrumb-item"><Link to="/masters/billing-address">Stock Transfer List</Link></li>
                                <li className="breadcrumb-item active" aria-current="page">Stock Tranfer</li>
                            </ol>
                        </nav>
                    </Block.HeadContent>
                    <Block.HeadContent>
            ...
            <Block>
                <Card>
                    <DataTable tableClassName="data-table-head-light table-responsive" data={StockTransfer} columns={stockTransferColumns} />
                </Card>
            </Block>
                        ...
                        <Row className="g-3">
                            ...
                            <Col lg="12">
                                <Form.Group className="form-group">
                                    ...
                                    <div className="form-control-wrap">
                                        <Form.Control id="qty" type="text" placeholder="Number of Quantity" />
                                    </div>
                                </Form.Group>
                            </Col>
                            ...
                            <Col lg="12">
                                <div className="d-flex gap g-2">
                                    <div className="gap-col">
                                        <Button variant="primary" onClick={handleCloseModal}>Transfer</Button>
                                    </div>
                                    <div className="gap-col">
