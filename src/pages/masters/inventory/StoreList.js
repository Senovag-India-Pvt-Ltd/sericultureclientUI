...
import StoreData, { storeColumns } from '../../../store/masters/inventory/StoreData';
...
function StoreListPage() {
  ...
  return (
    <Layout title="Store List" content="container">
                ...
                <Block.HeadContent>
                    ...
                    <nav>
                        <ol className="breadcrumb breadcrumb-arrow mb-0">
                          ...
                          <li className="breadcrumb-item"><Link to="/masters/billing-address">Store List</Link></li>
      ...
      <Block>
        <Card>
          <DataTable tableClassName="data-table-head-light table-responsive" data={StoreData} columns={storeColumns}/>
        </Card>
      </Block>
              ...
              <Row className="g-3">
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="name" type="text" placeholder="Enter Store Name"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="address1" type="text" placeholder="Enter Store Adderss"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="address2" type="text" placeholder="Enter Store Adderss"/>
                          </div>
                      </Form.Group>
                  </Col>
                  ...
                  <Col lg="12">
                      <Form.Group className="form-group">
                          ...
                          <div className="form-control-wrap">
                              <Form.Control id="pin" type="text" placeholder="Enter the PIN code"/>
                          </div>
                      </Form.Group>
                  </Col>
