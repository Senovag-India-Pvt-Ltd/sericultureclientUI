 ...
 useEffect(() => {
  ...
  return (
    <Layout title="Head Account">
      <style>{scHeadAccountEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Head Account")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Head Account Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
