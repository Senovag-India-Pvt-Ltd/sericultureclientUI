...
function ConfigureAdoptingBoilerView() {
  ...
  return (
    <Layout title={t("Configure Adapting Boiler Details")} content="container">
      <style>{configureAdoptingBoilerViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Configure Adapting Boiler Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const configureAdoptingBoilerViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
