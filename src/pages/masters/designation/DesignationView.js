...
function DesignationView() {
  ...
  return (
    <Layout title="Designation View">
      <style>{designationViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Designation View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Designation Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
                ...
                <Col lg="12">
                  <table className="table small table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td style={styles.ctstyle}> {t("Level")}</td>
