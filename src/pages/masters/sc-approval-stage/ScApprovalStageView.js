...
function ScApprovalStageView() {
  ...
  return (
    <Layout title="View Approval Stage Details">
      <style>{scApprovalStageViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Approval Stage Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const scApprovalStageViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
