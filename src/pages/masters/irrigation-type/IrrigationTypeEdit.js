...
function IrrigationTypeEdit() {
  ...
  const postData = (event) => {
    const datas = {
      ...
      irrigationTypeNameInKannada: data.irrigationTypeNameInKannada,
    };
  ...
  return (
    <Layout title="Irrigation Type">
      <style>{irrigationTypeEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Irrigation Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const irrigationTypeEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default IrrigationTypeEdit;
