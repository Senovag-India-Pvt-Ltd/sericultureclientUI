...
function GenerationNumberEdit() {
  ...
  return (
    <Layout title={t("Edit Generation Number")}>
      <style>{generationNumberEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Generation Number")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const generationNumberEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default GenerationNumberEdit;
