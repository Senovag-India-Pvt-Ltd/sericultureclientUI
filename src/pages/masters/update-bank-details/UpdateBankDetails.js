...
function UpdateBankDetails() {
  ...
  return (
    <Layout title={t("Update Bank Details")}>
      <style>{updateBankDetailsStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Update Bank Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
      ...
      <Block className="mt-n3 sh-form-wrap">
        ...
        >
          <Row className="g-0">
            <Card>
                <Card.Header style={{ fontWeight: "bold" }} className="sh-section-header">
                  <Icon name="edit" />
                  <span>{t("Bank Account Details")}</span>
                </Card.Header>
                <Card.Body>
                  <Row className="g-gs">
                    <Col lg="6">
