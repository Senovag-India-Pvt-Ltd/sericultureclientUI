...
function DiseaseStatusEdit() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURL + `diseaseStatus/edit`,{...data,diseaseStatusId:id})
        .then((response) => {
  ...
  return (
    <Layout title={t("Edit Disease Status")}>
      <style>{diseaseStatusEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Disease Status")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
export default DiseaseStatusEdit;
