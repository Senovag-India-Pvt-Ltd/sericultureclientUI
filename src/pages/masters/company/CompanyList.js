...
import CompanyData, { companyColumns } from '../../../store/masters/company/CompaniesData';
...
//   const handleCloseModal = () => setShowModal(false);
  ...
  return (
    <Layout title="Company List" content="container">
        <Block.Head>
            <Block.HeadBetween>
                <Block.HeadContent>
                    ...
                    <nav>
                        <ol className="breadcrumb breadcrumb-arrow mb-0">
                          ...
                          <li className="breadcrumb-item"><Link to="/masters/company-list">Company list</Link></li>
                ...
                <Block.HeadContent>
                  <ul className="d-flex">
                    <li>
                      <Link to="/masters/add-company" className="btn btn-primary btn-md d-md-none">
                        <Icon name="plus"/>
                        <span>Add</span>
                      </Link>
                    </li>
                    <li>
                      <Link to="/masters/add-company" className="btn btn-primary d-none d-md-inline-flex">
                        <Icon name="plus"/>
      ...
      <Block>
        <Card>
          <DataTable tableClassName="data-table-head-light table-responsive" data={CompanyData} columns={companyColumns}/>
        </Card>
      </Block>
