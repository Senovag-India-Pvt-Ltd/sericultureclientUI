...
function TrainingDeputedInstituteList() {
  ...
  return (
    <Layout title="Deputed Institute List">
      <style>{trainingDeputedInstituteListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Deputed Institute List")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const trainingDeputedInstituteListStyles = `
  .sh-page-header {
    padding: 20px 24px;
