...
function TrainingDeputedInstitute() {
  ...
  return (
    <Layout title="Deputed Institute">
      <style>{trainingDeputedInstituteStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Deputed Institute")} </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const trainingDeputedInstituteStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default TrainingDeputedInstitute;
