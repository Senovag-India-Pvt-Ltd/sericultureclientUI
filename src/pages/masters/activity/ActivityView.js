...
function ActivityView() {
  ...
  return (
    <Layout title="Activity View">
      <style>{activityViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Activity View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Activity View Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
