...
function IrrigationSourceEdit() {
  ...
  const postData = (event) => {
    const datas = {
      irrigationSourceId: id,
      irrigationSourceName: data.irrigationSourceName,
      irrigationSourceNameInKannada: data.irrigationSourceNameInKannada,
    };
  ...
  return (
    <Layout title="Irrigation Source">
      <style>{irrigationSourceEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Irrigation Source")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const irrigationSourceEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default IrrigationSourceEdit;
