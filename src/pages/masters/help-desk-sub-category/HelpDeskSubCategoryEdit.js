...
function HelpDeskSubCategoryEdit() {
  ...
  const getIdList = () => {
    setLoading(true);
    const response = api
      .get(baseURL + `hdSubCategoryMaster/get/${id}`)
      .then((response) => {
  ...
  return (
    <Layout title="Edit Sub  category">
      <style>{helpDeskSubCategoryEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Sub category")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Sub Category Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const helpDeskSubCategoryEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default HelpDeskSubCategoryEdit;
