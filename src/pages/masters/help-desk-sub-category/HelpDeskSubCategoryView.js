...
function HelpDeskSubCategoryView() {
  ...
  return (
    <Layout title="Sub Category View">
      <style>{helpDeskSubCategoryViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Sub Category View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const helpDeskSubCategoryViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
