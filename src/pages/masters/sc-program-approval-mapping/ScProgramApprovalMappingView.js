...
function ScProgramApprovalMappingView() {
  ...
  return (
    <Layout title="View Program Approval Mapping Details">
      <style>{scProgramApprovalMappingViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Program Approval Mapping Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("View Program Approval Mapping Details")}</span>
          </Card.Header>
          <Card.Body>
            <Row className="g-gs">
              <Col lg="12">
...
const scProgramApprovalMappingViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
