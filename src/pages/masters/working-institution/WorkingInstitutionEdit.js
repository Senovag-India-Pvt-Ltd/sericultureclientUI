...
function WorkingInstitutionEdit() {
  ...
  const postData = (event) => {
    const datas = {
      workingInstitutionId: id,
      workingInstitutionName: data.workingInstitutionName,
      workingInstitutionNameInKannada: data.workingInstitutionNameInKannada,
    };
  ...
  return (
    <Layout title="Edit WorkingInstitution">
      <style>{workingInstitutionEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Working Institution")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Working Institution")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const workingInstitutionEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default WorkingInstitutionEdit;
