...
function WorkingInstitution() {
  ...
  return (
    <Layout title="Working Institution">
      <style>{workingInstitutionStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Working Institution")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            ...
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="user" />
                <span>{t("Working Institution Details")}</span>
              </Card.Header>
              <Card.Body>
...
const workingInstitutionStyles = `
  .sh-page-header {
    padding: 20px 24px;
