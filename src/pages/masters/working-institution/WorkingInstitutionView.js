...
function WorkingInstitutionView() {
  ...
  return (
    <Layout title="WorkingInstitutions View">
      <style>{workingInstitutionViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("WorkingInstitution View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("WorkingInstitution Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
...
const workingInstitutionViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
