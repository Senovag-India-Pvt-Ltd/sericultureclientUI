...
function SourceOfMulberryList() {
  ...
  return (
    <Layout title="Source Of Mulberry List">
      <style>{sourceOfMulberryListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title"> {t("Source Of Mulberry List")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const sourceOfMulberryListStyles = `
  .sh-page-header {
    padding: 20px 24px;
