...
function SourceOfMulberryEdit() {
  ...
  return (
    <Layout title="Edit Source Of Mulberry">
      <style>{sourceOfMulberryEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Source Of Mulberry")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Edit Source Of Mulberry")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
                    ...
                    <Col lg="6">
                      <Form.Group className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <Form.Control
                            id="Source of Mulberry"
                            name="mulberrySourceName"
...
const sourceOfMulberryEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default SourceOfMulberryEdit;
