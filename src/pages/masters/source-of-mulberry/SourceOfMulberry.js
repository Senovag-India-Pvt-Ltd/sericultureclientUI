...
function SourceOfMulberry() {
  ...
  return (
    <Layout title="Source of Mulberry">
      <style>{sourceOfMulberryStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Source of Mulberry")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
export default SourceOfMulberry;
