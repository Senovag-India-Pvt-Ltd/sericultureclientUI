...
function TrainingCourseView() {
  ...
  const getIdList = () => {
    ...
    const response = api
      ...
      .then((response) => {
        setTrainingCourses(response.data.content);
        setLoading(false);
      })
      .catch((err) => {
        setTrainingCourses({});
  ...
  return (
    <Layout title="Training Courses View">
      <style>{trainingCourseViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Training Course View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const trainingCourseViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
