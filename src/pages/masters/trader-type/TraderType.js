...
function TraderType() {
  ...
  return (
    <Layout title="Trader Type">
      <style>{traderTypeStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Trader Type")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="user" />
                <span>{t("Trader Type Details")}</span>
              </Card.Header>
              <Card.Body>
