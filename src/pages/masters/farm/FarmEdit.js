...
function FarmEdit() {
  ...
  return (
    <Layout title={t("Edit Farm")}>
      <style>{farmEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Farm")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
                    ...
                    <Col lg="6">
                      <Form.Group className="form-group">
                        <Form.Label htmlFor="Farm">
                          {t("Farm Name")}<span className="text-danger">*</span>
                        </Form.Label>
