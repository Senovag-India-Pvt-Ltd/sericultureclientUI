...
function FarmView() {
  ...
  return (
    <Layout title={t("Farm View")}>
      <style>{farmViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Farm View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
                ...
                <Col lg="12">
                  <table className="table small table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td style={styles.ctstyle}>{t("Farm Name")}:</td>
                        <td>{Farm.farmName}</td>
                      </tr>
                      <tr>
