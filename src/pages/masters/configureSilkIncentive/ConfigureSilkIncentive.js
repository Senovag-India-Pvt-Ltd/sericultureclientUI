...
//     }, []);
  ...
  <Layout title={t("Configure Silk Incentive")}>
    <style>{configureSilkIncentiveStyles}</style>
    <Block.Head>
      <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("Configure Silk Incentive")}</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
        ...
        <Row className="g-4">
          ...
          <Card className="shadow-sm border-0 rounded-3">
            <Card.Header className="sh-section-header">
              <Icon name="setting" />
              <span>{t("Configure Silk Incentive Details")}</span>
            </Card.Header>
          ...
          <Card className="shadow-sm border-0 rounded-3 mt-4">
            <Card.Body className="text-center py-3">
              <div className="d-flex justify-content-center gap-3">
                <Button type="submit" variant="primary" className="px-4 sh-save-btn">
                  <Icon name="save" />
                  <span>{t("Save")}</span>
                </Button>
                <Button
...
const configureSilkIncentiveStyles = `
  .sh-page-header {
    padding: 20px 24px;
