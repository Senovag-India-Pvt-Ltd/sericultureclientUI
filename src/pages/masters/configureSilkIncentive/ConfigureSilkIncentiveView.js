...
function ConfigureSilkIncentiveView() {
  ...
  return (
    <Layout title={t("Configure Silk Incentive View")} content="container">
      <style>{configureSilkIncentiveViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Configure Silk Incentive View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const configureSilkIncentiveViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
