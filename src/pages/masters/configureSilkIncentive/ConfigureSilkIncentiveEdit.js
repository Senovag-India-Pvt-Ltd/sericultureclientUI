...
return (
  <Layout title={t("Edit Configure Silk Incentive")}>
    <style>{configureSilkIncentiveEditStyles}</style>
    <Block.Head>
      <div className="sh-page-header">
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2" className="sh-page-title">{t("Edit Configure Silk Incentive")}</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            <ul className="d-flex">
              <li>
        ...
        <Row className="g-3">
          ...
          <Card>
            <Card.Header className="sh-section-header">
              <Icon name="edit" />
              <span>{t("Edit Configure Silk Incentive")}</span>
            </Card.Header>
            <Card.Body>
              {loading ? (
...
const configureSilkIncentiveEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
