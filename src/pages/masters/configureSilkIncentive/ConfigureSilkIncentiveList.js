...
function ConfigureSilkIncentiveList() {
  ...
  return (
    <Layout title={t("Configure Silk Incentive List")}>
      <style>{configureSilkIncentiveListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Configure Silk Incentive List")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const configureSilkIncentiveListStyles = `
  .sh-page-header {
    padding: 20px 24px;
