...
function ScApprovingAuthorityView() {
  ...
  return (
    <Layout title="Approving Authority View">
      <style>{scApprovingViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title"> {t("Approving Authority View")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Card>
          <Card.Header className="sh-section-header">
            <Icon name="eye" />
            <span>{t("Approving Authority Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
                ...
                <Col lg="12">
                  <table className="table small table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td style={styles.ctstyle}>{t("Min Amount")}</td>
                        <td>{ScApprovingAuthority.minAmount}</td>
                      </tr>
                      <tr>
                        <td style={styles.ctstyle}>{t("Max Amount")}</td>
