...
function EmpanelledVendor() {
  ...
  return (
    <Layout title={t("Empaneled Vendor")}>
      <style>{empanelledVendorStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Empaneled Vendor")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
export default EmpanelledVendor;
