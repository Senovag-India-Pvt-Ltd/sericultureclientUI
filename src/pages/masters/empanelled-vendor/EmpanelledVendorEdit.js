...
function EmpanelledVendorEdit() {
  ...
  return (
    <Layout title={t("Edit Empaneled Vendor")}>
      <style>{empanelledVendorEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Empaneled Vendor")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="edit" />
                <span>{t("Empaneled Vendor Details")}</span>
              </Card.Header>
              <Card.Body>
                {loading ? (
...
const empanelledVendorEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default EmpanelledVendorEdit;
