...
function HelpDeskModuleEdit() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURL + `hdModuleMaster/edit`, data)
        .then((response) => {
  ...
  return (
    <Layout title="Edit Modules">
      <style>{helpDeskModuleEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Modules")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const helpDeskModuleEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default HelpDeskModuleEdit;
