...
function MaintenanceOfEggLayingSheetsList() {
  ...
  const handleView = (_id) => {
    navigate(`/seriui/maintenance-of-egg-laying-sheets-view/${_id}`);
  };

  const handleEdit = (_id) => {
    navigate(`/seriui/maintenance-of-egg-laying-sheets-edit/${_id}`);
  ...
  return (
    <Layout title={t("List Of Maintenance Of Egg Laying Sheets")}>
      <style>{maintenanceEggLayingSheetsListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("List Of Maintenance Of Egg Laying Sheets")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <div className="sh-table-wrap">
            <div style={{ overflowX: "auto" }}>
              <DataTable
                ...
                columns={MaintenanceOfEggLayingSheetsDataColumns}
                data={listData}
                highlightOnHover
                striped
                pointerOnHover
...
const maintenanceEggLayingSheetsListStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default MaintenanceOfEggLayingSheetsList;
