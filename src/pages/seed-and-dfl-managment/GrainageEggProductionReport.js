...
function GrainageEggProductionReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          errAlert(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the egg production report. Please try again.", { ns: "reports" }));
        }
      } finally {
      setIsLoading(false);
    }
  ...
  return (
    <Layout title={t("P4 Grainage Egg Production Report", { ns: "reports" })}>
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">{t("P4 Grainage Egg Production Report", { ns: "reports" })}</Block.Title>
          </Block.HeadContent>
        </Block.HeadBetween>
      </Block.Head>
      ...
      <Block className="mt-n4">
            ...
            <Row className="g-3 mb-3">
              ...
              <Col md={3}>
                <div className="gepr-kpi" style={{ background: "linear-gradient(135deg,#3b0764,#5b21b6)", borderRadius: "14px", padding: "18px 22px", boxShadow: "0 4px 20px rgba(91,33,182,0.30)", height: "100%" }}>
                  ...
                  <div style={{ color: "rgba(255,255,255,0.65)", fontSize: "11px" }}>{t("DFLs for {{month}}", { ns: "reports", month: monthLabel })}</div>
                </div>
              </Col>
              ...
              <Col md={4}>
                <div className="gepr-kpi" style={{ background: "linear-gradient(135deg,#064e3b,#065f46)", borderRadius: "14px", padding: "18px 22px", boxShadow: "0 4px 20px rgba(6,95,70,0.30)", height: "100%" }}>
                  ...
                  <div style={{ color: "rgba(255,255,255,0.65)", fontSize: "10px", marginTop: "4px" }}>{t("of {{target}} target DFLs", { ns: "reports", target: targetTotal.toLocaleString() })}</div>
                </div>
              </Col>
              ...
              <Col md={3}>
                <div className="gepr-kpi" style={{ background: "linear-gradient(135deg,#78350f,#92400e)", borderRadius: "14px", padding: "18px 22px", boxShadow: "0 4px 20px rgba(146,64,14,0.30)", height: "100%" }}>
                  ...
                  <div style={{ color: "rgba(255,255,255,0.65)", fontSize: "11px" }}>{t("DFLs next month", { ns: "reports" })}</div>
                </div>
              </Col>
              ...
              <Col md={2}>
                <div style={{ display: "flex", flexDirection: "column", gap: "8px", height: "100%", justifyContent: "center" }}>
                  {[
                    { label: t("Grainage"), value: (i18n.language === "kn" ? (selectedGrainage?.grainageMasterNameInKannada || selectedGrainage?.grainageMasterName) : selectedGrainage?.grainageMasterName) || "—", accent: "#c4b5fd", bg: "linear-gradient(135deg,#faf5ff,#ede9fe)", text: "#5b21b6" },
        ...
        {hasReport && !reportRow && (
          <div className="mt-4 text-center" style={{ color: "#a0aec0", fontSize: "14px", padding: "30px" }}>
            {t("No egg production data found for the selected filters.", { ns: "reports" })}
          </div>
        )}
      </Block>
    </Layout>
