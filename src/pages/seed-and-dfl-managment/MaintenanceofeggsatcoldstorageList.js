...
function MaintenanceofeggsatcoldstorageList() {
  ...
  return (
    <Layout title={t("List Of Maintenance Of Eggs At Cold Storage")}>
      <style>{maintenanceEggsColdStorageListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("List Of Maintenance Of Eggs At Cold Storage")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const maintenanceEggsColdStorageListStyles = `
  .sh-page-header {
    padding: 20px 24px;
