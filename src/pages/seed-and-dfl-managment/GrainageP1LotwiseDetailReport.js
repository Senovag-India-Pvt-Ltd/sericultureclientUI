...
function GrainageP1LotwiseDetailReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr("Fetch Failed", backendMsg || err?.message || "Failed to load the P1 Lot-wise Detail report.");
        }
  ...
  return (
    <Layout title={t("P1 Grainage Lot-wise DFL Production Detail (top 4 + totals)")}>
