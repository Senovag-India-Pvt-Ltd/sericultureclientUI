...
function AdsRearerDetailsReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr("Fetch Failed", backendMsg || err?.message || "Failed to load the ADS Rearer Details report.");
        }
  ...
  return (
    <Layout title={t("ADS · TSC Farmer Demographics Report")}>
          ...
          <div className="adsrear-wrap mt-4">
            <div className="d-flex flex-wrap gap-3 mb-3 align-items-center">
              <div style={kpi("#cffafe", "#67e8f9", "#155e75")}>
                <span style={kpiLbl("#155e75")}>TSCs</span>
