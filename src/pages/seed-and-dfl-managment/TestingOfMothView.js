...
function TestingOfMothView() {
  ...
  return (
    <Layout title={t("View Testing Of Moth/Pupa Details")}>
      <style>{testingOfMothViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Testing Of Moth/Pupa Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-view-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="search" />
            <span>{t("Testing Of Moth Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
                ...
                <Col lg="12">
                  <DetailGrid
                    items={[
                      ...
                      { label: t("Pebrine free status of pupa & Moth"), value: testingMoth.pebrineFreeStatusOfPupaAndMoth },
                      { label: t("Source details"), value: testingMoth.sourceDetails },
                      { label: t("Number of Beds"), value: testingMoth.numberOfBeds },
                      { label: t("Number of Diseased Beds"), value: testingMoth.numberOfDiseasedBeds },
                    ]}
                  />
                </Col>
              </Row>
