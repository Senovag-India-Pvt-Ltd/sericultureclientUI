...
function MaintenanceOfEggsAtColdList() {
  ...
  return (
    <Layout title={t("List Of Maintenance Of Eggs At Cold Storage NSSO")}>
      <style>{maintenanceEggsAtColdListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("List Of Maintenance Of Eggs At Cold Storage NSSO")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const maintenanceEggsAtColdListStyles = `
  .sh-page-header {
    padding: 20px 24px;
