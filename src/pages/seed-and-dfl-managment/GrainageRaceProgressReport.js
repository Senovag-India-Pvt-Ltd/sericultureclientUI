...
function GrainageRaceProgressReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the progress report data. Please try again.", { ns: "reports" }));
        }
  ...
  return (
    <Layout title={t("Race-wise Progress (CSR-2 / CSR-4)", { ns: "reports" })}>
