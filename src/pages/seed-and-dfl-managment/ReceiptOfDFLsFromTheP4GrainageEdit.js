...
function ReceiptOfDFLsFromTheP4GrainageEdit() {
  ...
  return (
    <Layout title={t("Receipt of DFLs from the P4 grainage")}>
      <style>{receiptDflsEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Receipt of DFLs from the P4 grainage")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card>
            <Card.Header className="sh-section-header">
              <Icon name="layers" />
              <span>{t("Edit Receipt of DFLs from the P4 grainage")}</span>
            </Card.Header>
            <Card.Body>
              {loading ? (
