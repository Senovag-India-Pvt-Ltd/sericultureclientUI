...
function SeedMarketStaffList() {
  ...
  return (
    <Layout title={t("Seed Market Staff Establishment List")}>
      <style>{seedMarketStaffListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Seed Market Staff Establishment List")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
...
const seedMarketStaffListStyles = `
  .sh-page-header {
    padding: 20px 24px;
