...
function FarmForm4CropProgressReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the Form-4 Crop Progress report.", { ns: "reports" }));
        }
  ...
  return (
    <Layout title={t("Form-4 · Farm Crop Progress Report", { ns: "reports" })}>
