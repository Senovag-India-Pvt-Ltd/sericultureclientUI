...
useEffect(() => {
  ...
  return (
    <Layout title="Add Preparation of Eggs (DFLs)">
      <style>{preparationEggsDFLsAddStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">Add Preparation of Eggs (DFLs)</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
                  ...
                  <Block>
                    <Card className="sh-section-card">
                      <Card.Header className="sh-section-header">
                        <Icon name="grid" />
                        <span>Add Preparation of Eggs (DFLs)</span>
                      </Card.Header>
                      <Card.Body>
                        <Row className="g-gs">
                        {/* <Col lg="4">
...
const preparationEggsDFLsAddStyles = `
  .sh-page-header {
    padding: 20px 24px;
