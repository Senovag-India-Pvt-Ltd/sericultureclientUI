...
function ColdStorageScheduleBV() {
  ...
  return (
    <Layout title={t("Cold Storage Schedule BV")}>
      <style>{coldStorageScheduleBVFormStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Cold Storage Schedule BV")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="calendar" />
              <span>{t("Cold Storage Schedule BV")}</span>
            </Card.Header>
                    <Card.Body>
                        <Row className="g-gs">
...
const coldStorageScheduleBVFormStyles = `
  .sh-page-header {
    padding: 20px 24px;
