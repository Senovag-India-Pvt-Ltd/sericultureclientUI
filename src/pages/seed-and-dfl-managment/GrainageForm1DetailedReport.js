...
function GrainageForm1DetailedReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr("Fetch Failed", backendMsg || err?.message || "Failed to load the Grainage Form-1 Detailed report.");
        }
  ...
  return (
    <Layout title={t("Grainage Form-1 · Detailed Monthly Progress")}>
