...
const [showModal7, setShowModal7] = useState(false);
 ...
 // <-- Add this// optional loading spinner
...
const [showModal8, setShowModal8] = useState(false);
  ...
  const RearingOfDFLSForThe8LinesDataColumns = [
    ...
    {
      name: t("Worms Tested (4th Stage)"),
      selector: (row) => row.wormsTested4thStage,
      cell: (row) => <span>{row.wormsTested4thStage}</span>,
      sortable: true,
      hide: "md",
    },
    {
      name: t("Destroyed Worms"),
      selector: (row) => row.destroyedWorms,
      cell: (row) => <span>{row.destroyedWorms}</span>,
      sortable: true,
      hide: "md",
    },
    {
      name: t("Average Yield (count)"),
      selector: (row) => row.avgYieldCount,
      cell: (row) => <span>{row.avgYieldCount}</span>,
      sortable: true,
      hide: "md",
    },
    {
      name: t("Yield Weight (grams)"),
      selector: (row) => row.yieldWeightGrams,
      cell: (row) => <span>{row.yieldWeightGrams}</span>,
      sortable: true,
      hide: "md",
    },
    {
      name: t("Disposal Quantity"),
      selector: (row) => row.disposalQuantity,
      cell: (row) => <span>{row.disposalQuantity}</span>,
      sortable: true,
      hide: "md",
    },
    {
      name: t("Reeling Cocoons"),
      selector: (row) => row.reelingCocoons,
      cell: (row) => <span>{row.reelingCocoons}</span>,
      sortable: true,
      hide: "md",
    },
    {
      name: t("P4 Seed Cocoons"),
      selector: (row) => row.p4SeedCocoons,
      cell: (row) => <span>{row.p4SeedCocoons}</span>,
      sortable: true,
      hide: "md",
    },
