...
function TscMonthlyP1ChawkiLotwiseReport() {
  ...
  const showWarn = (msg) =>
    Swal.fire({
      ...
      confirmButtonText: t("Got it", { ns: "reports" }), confirmButtonColor: "#d97706", background: "#fff", customClass: { popup: "tscp1chk-swal" },
    });
  const showErr = (title, msg) =>
    Swal.fire({
      ...
      confirmButtonText: t("Close"), confirmButtonColor: "#e53e3e", background: "#fff", customClass: { popup: "tscp1chk-swal" },
    });
    ...
    try {
      ...
      setDataRows(Array.isArray(res.data) ? res.data : []); setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the TSC Monthly P1 Chawki Lot-wise (Sheet 14) report.", { ns: "reports" }));
        }
      }
  ...
  return (
    <Layout title={t("TSC Monthly P1 Chawki Lot-wise — Sheet 14", { ns: "reports" })}>
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">
            ...
            <Form onSubmit={handleView}>
              ...
              {hasReport && (
                <Row className="g-2 mt-2 align-items-end">
                  <Col md={8}>
                    <label style={lbl}>{t("Quick Search (ವಲಯ, TSC, Farmer, Village, Lot, Race)", { ns: "reports" })}</label>
          ...
          <div className="tscp1chk-wrap mt-4">
            ...
            <div className="d-flex flex-wrap gap-3 mb-3 align-items-stretch">
              ...
              <div style={{ background: "linear-gradient(135deg,#fef3c7,#fef9ec)", border: "1.5px solid #fcd34d", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "200px" }}>
                <span style={{ fontSize: "11px", color: "#92400e", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".07em" }}>{t("Avg % Chawki", { ns: "reports" })}</span>
              ...
              <div style={{ background: "linear-gradient(135deg,#cffafe,#ecfeff)", border: "1.5px solid #67e8f9", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "200px" }}>
                <span style={{ fontSize: "11px", color: "#0e7490", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".07em" }}>{t("TSCs / Farmers / Villages / Lots", { ns: "reports" })}</span>
              ...
              <div style={{ background: "linear-gradient(135deg,#fef9ec,#fef3c7)", border: "1.5px solid #fcd34d", borderRadius: "12px", padding: "10px 16px", minWidth: "260px" }}>
                <div style={{ fontSize: "10.5px", fontWeight: 800, color: "#92400e", textTransform: "uppercase", letterSpacing: ".07em", marginBottom: "5px" }}>{t("DFLs by Week", { ns: "reports" })}</div>
              ...
              <div style={{ background: "linear-gradient(135deg,#ede9fe,#f5f3ff)", border: "1.5px solid #c4b5fd", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "200px" }}>
                <span style={{ fontSize: "11px", color: "#7c3aed", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".07em" }}>{t("Top Race · DFLs", { ns: "reports" })}</span>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "12px", minWidth: "1500px" }}>
                  ...
                  <tbody>
                    {filteredRows.length === 0 && (
                      <tr><td colSpan={10} style={{ padding: "40px 20px", textAlign: "center", color: "#a0aec0", fontSize: "14px" }}>{dataRows.length === 0 ? "ಯಾವುದೇ ಮಾಹಿತಿ ಲಭ್ಯವಿಲ್ಲ / No records found." : t("No matches for the current filters.", { ns: "reports" })}</td></tr>
                    )}
