...
function MaintenanceOfPiercedCocoonsView() {
  ...
  return (
    <Layout title={t("View Maintenance Of Pierced Cocoons Details")}>
      <style>{maintenancePiercedCocoonsViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Maintenance Of Pierced Cocoons Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-view-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="package" />
            <span>{t("Maintenance Of Pierced Cocoons Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
                ...
                <Col lg="12">
                  <DetailGrid
                    items={[
                      ...
                      { label: t("Lot Number"), value: piercedCocoons.lotNumber },
                      { label: t("Storage Date"), value: formatDate(piercedCocoons.storageDate) },
                      { label: t("Quantity in Kgs"), value: piercedCocoons.quantityInNumberAndKgs },
                    ]}
                  />
                </Col>
              </Row>
...
const maintenancePiercedCocoonsViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
