...
function MaintenanceOfPiercedCocoonsList() {
  ...
  const handleView = (_id) => {
    navigate(`/seriui/maintenance-of-pierced-cocoons-view/${_id}`);
  };

  const handleEdit = (_id) => {
    navigate(`/seriui/maintenance-of-pierced-cocoons-edit/${_id}`);
  ...
  return (
    <Layout title={t("List Of Maintenance Of Pierced Cocoons")}>
      <style>{maintenancePiercedCocoonsListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("List Of Maintenance Of Pierced Cocoons")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <div className="sh-table-wrap">
            <div style={{ overflowX: "auto" }}>
              <DataTable
                ...
                columns={MaintenanceOfPiercedCocoonsDataColumns}
                data={listData}
                highlightOnHover
                striped
                pointerOnHover
...
const maintenancePiercedCocoonsListStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default MaintenanceOfPiercedCocoonsList;
