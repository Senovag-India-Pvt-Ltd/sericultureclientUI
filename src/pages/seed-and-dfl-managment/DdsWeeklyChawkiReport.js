...
function DdsWeeklyChawkiReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the DDS Weekly Chawki report.", { ns: "reports" }));
        }
  ...
  return (
    <Layout title={t("DDS · Weekly Chawki Report", { ns: "reports" })}>
          ...
          <div className="ddswk-wrap mt-4">
            <div className="d-flex flex-wrap gap-3 mb-3 align-items-center">
              <div style={kpi("#dbeafe", "#93c5fd", "#1e40af")}>
                <span style={kpiLbl("#1e40af")}>{t("TSCs", { ns: "reports" })}</span>
