...
function DispatchofCocoonstoP4GrainageEdit() {
  ...
  return (
    <Layout title={t("Edit Dispatch of Cocoons to P4 Grainage")}>
      <style>{dispatchCocoonsEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Dispatch of Cocoons to P4 Grainage")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="truck" />
              <span>{t("Edit Dispatch of Cocoons to P4 Grainage")}</span>
            </Card.Header>
            <Card.Body>
              {loading ? (
...
const dispatchCocoonsEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
