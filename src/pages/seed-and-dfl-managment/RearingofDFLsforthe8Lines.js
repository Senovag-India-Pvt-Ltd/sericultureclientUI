...
function RearingofDFLsforthe8Lines() {
  ...
  return (
    <Layout title={t("Rearing of DFLs for the 8 lines")}>
      <style>{rearing8LinesFormStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Rearing of DFLs for the 8 lines")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card>
            <Card.Header className="sh-section-header">
              <Icon name="grid" />
              <span>{t("Rearing of DFLs for the 8 lines")}</span>
            </Card.Header>
                    <Card.Body>
                        <Row className="g-gs">
                  <Col lg="4">
