...
function TscMonthlyP1CocoonLotwiseReport() {
  ...
  const showWarn = (msg) =>
    Swal.fire({
      ...
      confirmButtonText: "Got it", confirmButtonColor: "#d97706", background: "#fff", customClass: { popup: "tscp1coc-swal" },
    });
  const showErr = (title, msg) =>
    Swal.fire({
      ...
      confirmButtonText: "Close", confirmButtonColor: "#e53e3e", background: "#fff", customClass: { popup: "tscp1coc-swal" },
    });
    ...
    try {
      ...
      setDataRows(Array.isArray(res.data) ? res.data : []); setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr("Fetch Failed", backendMsg || err?.message || "Failed to load the TSC Monthly P1 Cocoon Lot-wise (Sheet 15) report.");
        }
      }
  ...
  return (
    <Layout title={t("TSC Monthly P1 Cocoon Lot-wise — Sheet 15")}>
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">
            ...
            <Form onSubmit={handleView}>
              ...
              {hasReport && (
                <Row className="g-2 mt-2 align-items-end">
                  <Col md={5}>
                    <label style={lbl}>Quick Search (TSC, Farmer, Village, Lot, Race, Market)</label>
          ...
          <div className="tscp1coc-wrap mt-4">
            ...
            <div className="d-flex flex-wrap gap-3 mb-3 align-items-stretch">
              ...
              <div style={{ background: "linear-gradient(135deg,#dbeafe,#eff6ff)", border: "1.5px solid #93c5fd", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "150px" }}>
                ...
                <span className="tscp1coc-num" style={{ fontSize: "10.5px", color: "#1e40af", fontWeight: 700, marginTop: "1px" }}>Cocoon-yielded: {kpis.cocoonRowsCount} ({kpis.conversionPct.toFixed(1)}%)</span>
              </div>
              ...
              <div style={{ background: "linear-gradient(135deg,#fef3c7,#fef9ec)", border: "1.5px solid #fcd34d", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "180px" }}>
                <span style={{ fontSize: "11px", color: "#92400e", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".07em" }}>Total Cocoon</span>
                <span className="tscp1coc-num" style={{ fontSize: "16px", color: "#78350f", fontWeight: 800, marginTop: "2px" }}>{fmtDec(kpis.totalKg)} kg</span>
                <span className="tscp1coc-num" style={{ fontSize: "10.5px", color: "#a16207", fontWeight: 700, marginTop: "1px" }}>Avg Yield: {fmtDec(kpis.avgYield)} kg / 100 DFLs</span>
              </div>
              <div style={{ background: "linear-gradient(135deg,#fce7f3,#fdf2f8)", border: "1.5px solid #f9a8d4", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "180px" }}>
                <span style={{ fontSize: "11px", color: "#9d174d", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".07em" }}>Total Sale Value</span>
                <span className="tscp1coc-num" style={{ fontSize: "16px", color: "#831843", fontWeight: 800, marginTop: "2px" }}>{fmtINR(kpis.totalSale)}</span>
                <span className="tscp1coc-num" style={{ fontSize: "10.5px", color: "#be185d", fontWeight: 700, marginTop: "1px" }}>Avg Rate: ₹ {fmtDec(kpis.avgRate)} / kg</span>
              </div>
              <div style={{ background: "linear-gradient(135deg,#fef9ec,#fef3c7)", border: "1.5px solid #fcd34d", borderRadius: "12px", padding: "10px 16px", minWidth: "260px" }}>
                <div style={{ fontSize: "10.5px", fontWeight: 800, color: "#92400e", textTransform: "uppercase", letterSpacing: ".07em", marginBottom: "5px" }}>Cocoon kg by Week</div>
              ...
              <div style={{ background: "linear-gradient(135deg,#cffafe,#ecfeff)", border: "1.5px solid #67e8f9", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "180px" }}>
                <span style={{ fontSize: "11px", color: "#0e7490", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".07em" }}>TSCs / Farmers / Lots / Markets</span>
              ...
              <div style={{ background: "linear-gradient(135deg,#ede9fe,#f5f3ff)", border: "1.5px solid #c4b5fd", borderRadius: "12px", padding: "10px 18px", display: "flex", flexDirection: "column", minWidth: "200px" }}>
                <span style={{ fontSize: "11px", color: "#7c3aed", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".07em" }}>Top Market · Cocoon kg</span>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "12px", minWidth: "2100px" }}>
                  ...
                  <tbody>
                    {filteredRows.length === 0 && (
                      <tr><td colSpan={14} style={{ padding: "40px 20px", textAlign: "center", color: "#a0aec0", fontSize: "14px" }}>{dataRows.length === 0 ? "ಯಾವುದೇ ಮಾಹಿತಿ ಲಭ್ಯವಿಲ್ಲ / No records found." : `No matches for the current filters.`}</td></tr>
                    )}
