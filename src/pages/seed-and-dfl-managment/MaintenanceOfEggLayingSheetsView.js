...
function MaintenanceOfEggLayingSheetsView() {
  ...
  return (
    <Layout title={t("View Maintenance Of Egg Laying Sheets Details")}>
      <style>{maintenanceEggLayingSheetsViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Maintenance Of Egg Laying Sheets Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
      ...
      <Block className="mt-n4 sh-view-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="grid" />
            <span>{t("Maintenance Of Egg Laying Sheets Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
              ...
              <Row className="g-gs">
                <Col lg="12">
                  <DetailGrid
                    items={[
                      { label: t("ID"), value: eggSheets.id },
                      { label: t("Lot Number"), value: eggSheets.lotNumber },
                      { label: t("Date"), value: eggSheets.date },
                      { label: t("Number Of Egg Sheets"), value: eggSheets.numberOfEggSheetsUsed },
                      { label: t("Egg Sheet Number"), value: eggSheets.eggSheetNumbers },
                      { label: t("Balance No Of Sheets"), value: eggSheets.balanceNumberOfSheets },
                    ]}
                  />
                </Col>
              </Row>
...
const maintenanceEggLayingSheetsViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
