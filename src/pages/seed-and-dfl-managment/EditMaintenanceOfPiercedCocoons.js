...
function EditMaintenanceOfPiercedCocoons() {
  ...
  return (
    <Layout title={t("Edit Maintenance Of Pierced Cocoon")}>
      <style>{editMaintenancePiercedCocoonsStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Maintenance Of Pierced Cocoon")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="package" />
              <span>{t("Edit Maintenance Of Pierced Cocoons")}</span>
            </Card.Header>
            <Card.Body>
              {loading ? (
...
const editMaintenancePiercedCocoonsStyles = `
  .sh-page-header {
    padding: 20px 24px;
