...
function MaintenanceOfEggsAtColdStorageView() {
  ...
  return (
    <Layout title={t("View Maintenance Of Egg At Cold Storage Details")}>
      <style>{maintenanceEggsColdStorageViewStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("View Maintenance Of Egg At Cold Storage Details")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
                ...
                <Col lg="12">
                  <DetailGrid
                    items={[
                      ...
                      { label: t("Number Of DFLs"), value: coldStorage.numberOfDFLs },
                      { label: t("Date Of Cold Storage"), value: coldStorage.dateOfColdStore },
                      { label: t("Laid On Date"), value: coldStorage.laidOnDate },
                      { label: t("Date Of Release"), value: coldStorage.dateOfRelease },
...
const maintenanceEggsColdStorageViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
