...
function PreparationofeggsDFLsList() {
      ...
      cell: (row) => (
        ...
        <div className="d-flex align-items-center flex-nowrap gap-2 text-start w-100" style={{ whiteSpace: "nowrap" }}>
          ...
          <Button
            ...
            className="d-inline-flex align-items-center gap-1 shadow-sm text-white text-nowrap"
            style={{ borderRadius: "6px", fontWeight: 500, fontSize: "12.5px", paddingInline: "10px" }}
            title={t("Add DFLs")}
          >
            <Icon name="plus-circle" />
            <span>{t("Add DFLs")}</span>
          </Button>
          {/* <Button
            variant="danger"
            size="sm"
  ...
  return (
    <Layout title={t("Preparation of Eggs (DFLs) List")}>
      <style>{preparationEggsDFLsListStyles}</style>
      <Block.Head>
...
const preparationEggsDFLsListStyles = `
  .sh-page-header {
    padding: 20px 24px;
