...
function ColdStorageScheduleBVEdit() {
  ...
  return (
    <Layout title={t("Edit Cold Storage Schedule BV")}>
      <style>{coldStorageScheduleBVEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Cold Storage Schedule BV")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="calendar" />
              <span>{t("Edit Cold Storage Schedule BV")}</span>
                </Card.Header>
                    <Card.Body>
                    {loading ? (
...
const coldStorageScheduleBVEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
