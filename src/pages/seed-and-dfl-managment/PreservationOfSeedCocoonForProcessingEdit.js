...
useEffect(() => {
  ...
  return (
    <Layout title={t("Preservation of seed Cocoon for processing")}>
      <style>{preservationSeedCocoonEditStyles}</style>
      <Block.Head>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="archive" />
              <span>{t("Edit Preservation of seed cocoon for processing")}</span>
            </Card.Header>
            <Card.Body>
              {loading ? (
                ...
                <Col lg="4">
                  <Form.Group className="form-group mt-n4">
                   ...
                   {t("Lot Number")}
                   {/* r<span className="text-danger">*</span> */}
                    </Form.Label>
                  ...
                  <Form.Group className="form-group mt-n4">
                    ...
                    <div className="form-control-wrap">
                      <Form.Control
                        ...
                        onChange={handleInputs}
                        type="text"
                        placeholder={t("Enter Name of the Farmer")}
                        // required
                      />
                      {/* <Form.Control.Feedback type="invalid">
...
const preservationSeedCocoonEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
