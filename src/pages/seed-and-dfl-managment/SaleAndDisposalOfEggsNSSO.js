...
function SaleAndDisposalOfEggsNSSO() {
  ...
  return (
    <Layout title={t("Sale/Disposal of Eggs NSSO")}>
      <style>{saleDisposalEggsNssoFormStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Sale/Disposal of Eggs NSSO")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
          ...
          <Row className="g-1 ">
            <Block className="mt-3">
              <Card className="sh-section-card">
                <Card.Header className="sh-section-header">
                  <Icon name="cart" />
                  <span>{t("Sale / Disposal of DFLs(egg)")}</span>
                </Card.Header>
                <Card.Body>
                  <Row className="g-gs">
                    {/* <Col lg="4">
                        ...
                        <Form.Group className="form-group mt-n4">
                          ...
                          <div className="form-control-wrap">
                            <Form.Control
                              ...
                              onChange={handleInputs}
                              type="text"
                              placeholder={t("Enter Name and address farm")}
                              required
                              readOnly
                            />
                            <Form.Control.Feedback type="invalid">
                              {t("Name and address farm is required")}
                            </Form.Control.Feedback>
                          </div>
                        </Form.Group>
                      </Col>
...
const saleDisposalEggsNssoFormStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default SaleAndDisposalOfEggsNSSO;
