...
function FarmForm3PerformanceReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the Form-3 Performance report.", { ns: "reports" }));
        }
  ...
  return (
    <Layout title={t("Form-3 · Farm Performance Report", { ns: "reports" })}>
