...
function RegisteredSeedProducerNssoGrainages() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      api
        .post(baseURLSeedDfl + `EggPreparationRsso/add-info`, payload)
        .then((response) => {
                  ...
                  <Form.Group className="form-group mt-n4">
                    ...
                    <div className="form-control-wrap">
                      <Form.Control
                        ...
                        onChange={handleInputs}
                        placeholder={t("Enter Egg sheet serial number")}
                      />
                    </div>
                  </Form.Group>
                </Col>
...
const registeredSeedProducerNssoFormStyles = `
  .sh-page-header {
    padding: 20px 24px;
