...
function GrainageBriefMonthlyReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the Grainage Monthly Brief Progress report.", { ns: "reports" }));
        }
  ...
  return (
    <Layout title={t("Grainage Monthly Brief Progress Report (Bivoltine)", { ns: "reports" })}>
