...
function GrainageLotwiseDetailReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr("Fetch Failed", backendMsg || err?.message || "Failed to load the Grainage Lot-wise Detail report.");
        }
  ...
  return (
    <Layout title={t("Grainage Lot-wise Detail Report (top 4 lots)")}>
