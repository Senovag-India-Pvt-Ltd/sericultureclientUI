...
function EditTestingOfMoth() {
  ...
  return (
    <Layout title={t("Edit Testing Of Moth")}>
      <style>{testingOfMothEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Edit Testing Of Moth")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="search" />
              <span>{t("Edit Testing Of Moth")}</span>
            </Card.Header>
            <Card.Body>
              {loading ? (
