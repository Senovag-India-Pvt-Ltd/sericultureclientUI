...
function MaintenancePiercedCocoons() {
  return (
    <Layout title="Maintenance of Pierced Cocoons" content="container">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">Maintenance of Pierced Cocoons</Block.Title>
            <nav>
...
export default MaintenancePiercedCocoons;
