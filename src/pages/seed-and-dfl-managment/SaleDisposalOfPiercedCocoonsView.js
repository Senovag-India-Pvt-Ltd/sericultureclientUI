...
function SaleDisposalOfPiercedCocoonsView() {
  ...
  return (
    <Layout title={t("Sale Disposal Of Pierced Cocoons View")}>
      <style>{saleDisposalPiercedCocoonsViewStyles}</style>
      <Block.Head>
      ...
      <Block className="mt-n4 sh-view-wrap">
        <Card className="sh-section-card">
          <Card.Header className="sh-section-header">
            <Icon name="cart" />
            <span>{t("Sale/Disposal of Pierced Cocoons Details")}</span>
          </Card.Header>
          <Card.Body>
            {loading ? (
              ...
              <Row className="g-gs">
                <Col lg="12">
                  <DetailGrid
                    items={[
                      { label: t("ID"), value: piercedCocoons.id },
                      { label: t("Total Lots"), value: piercedCocoons.lotNumber },
                      { label: t("Race"), value: piercedCocoons.raceName },
                      { label: t("Date of disposal"), value: piercedCocoons.dateOfDisposal },
                      { label: t("Name and address of the PC Merchant"), value: piercedCocoons.merchantNameAndAddress },
                      { label: t("Number of cocoons"), value: piercedCocoons.numberOfCocoons },
                      { label: t("Number Of Cocoons in Kgs"), value: piercedCocoons.quantityInKgs },
                      { label: t("Rate per Kgs"), value: piercedCocoons.ratePerKg },
                      { label: t("Total Amount"), value: piercedCocoons.totalAmount },
                    ]}
                  />
                </Col>
              </Row>
...
const saleDisposalPiercedCocoonsViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
