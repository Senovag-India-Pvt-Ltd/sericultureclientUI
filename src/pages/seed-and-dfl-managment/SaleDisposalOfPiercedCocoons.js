...
function SaleDisposalOfPiercedCocoons() {
  ...
  return (
    <Layout title={t("Sale/Disposal of Pierced Cocoons")}>
      <style>{saleDisposalPiercedCocoonsFormStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Sale/Disposal of Pierced Cocoons")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
                <li>
        ...
        <Form noValidate validated={validated} onSubmit={postData}>
          ...
          <Card className="sh-section-card">
            <Card.Header className="sh-section-header">
              <Icon name="cart" />
              <span>{t("Sale/Disposal of Pierced Cocoons")}</span>
            </Card.Header>
            <Card.Body>
                ...
                {/* <Col lg="4">
                  <Form.Group className="form-group mt-n4">
                    ...
                    <div className="form-control-wrap">
                      ...
                      />
                      <Form.Control.Feedback type="invalid">
                        {t("Number of cocoons is required")}
                      </Form.Control.Feedback>
                    </div>
                  </Form.Group>
                </Col> */}
                  ...
                  <Form.Group className="form-group mt-n4">
                    ...
                    <div className="form-control-wrap">
                      <Form.Control
                        ...
                        onChange={handleInputs}
                        type="number"
                        placeholder={t("Enter Quantity in gs")}
                        required
                      />
                      <Form.Control.Feedback type="invalid">
...
const saleDisposalPiercedCocoonsFormStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default SaleDisposalOfPiercedCocoons;
