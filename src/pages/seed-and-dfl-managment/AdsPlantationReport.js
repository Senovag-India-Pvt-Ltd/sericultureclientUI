...
function AdsPlantationReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the ADS Plantation report.", { ns: "reports" }));
        }
      } finally {
      setIsLoading(false);
    }
  ...
  return (
    <Layout title={t("ADS · Mulberry Plantation Statistics", { ns: "reports" })}>
          ...
          <div className="adsplant-wrap mt-4">
            ...
            <div className="d-flex flex-wrap gap-3 mb-3 align-items-center">
              <div style={kpi("#bbf7d0", "#86efac", "#14532d", "#14532d")}>
                <span style={kpiLbl("#14532d")}>{t("TSCs", { ns: "reports" })}</span>
