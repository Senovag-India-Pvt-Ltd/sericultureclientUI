...
function GrainageForm2SourceReport() {
    ...
    try {
      ...
      setHasReport(true);
        ...
        if (status === 404 || status === 204) {
          ...
          showErr(t("Fetch Failed", { ns: "reports" }), backendMsg || err?.message || t("Failed to load the Grainage Form-2 Source-split report.", { ns: "reports" }));
        }
  ...
  return (
    <Layout title={t("Form-2 · Source-split Monthly Progress", { ns: "reports" })}>
