...
function SaleDisposalofDFLseggsView() {
  ...
  return (
    <Layout title={t("Sale / Disposal of DFL's(eggs) View")}>
      <style>{saleDisposalDFLsEggsViewStyles}</style>
      <Block.Head>
                ...
                <Col lg="12">
                  <DetailGrid
                    items={[
                      ...
                      { label: t("Release Date"), value: seedDisposal.releaseDate },
                      { label: t("Date of disposal/Burnt"), value: seedDisposal.dateOfDisposal },
                      { label: t("Expected Date of Hatching"), value: seedDisposal.expectedDateOfHatching },
                      { label: t("Number Of Dfls Disposed"), value: seedDisposal.numberOfDflsDisposed },
                      { label: t("Fruits Id"), value: seedDisposal.fruitsId },
                      { label: t("Type"), value: seedDisposal.userType },
                      { label: t("Name and address of the PC Merchant"), value: seedDisposal.nameAndAddressOfTheFarm },
                      { label: t("Rate per 100 Dfls Price"), value: seedDisposal.ratePer100DflsPrice },
                      { label: t("Remarks"), value: seedDisposal.reason },
                      { label: t("DFLs Type"), value: seedDisposal.dflsType },
                      { label: t("Remaining Dfls"), value: seedDisposal.remainingDfls },
                      { label: t("External User"), value: seedDisposal.externalUserName },
...
const saleDisposalDFLsEggsViewStyles = `
  .sh-page-header {
    padding: 20px 24px;
