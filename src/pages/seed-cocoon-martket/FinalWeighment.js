  ...
  const [hardCodeDataList] = useState([
    {
      slNo: "1",
      date: "03 Oct 2024",
      dateOfBiddingSlip: "24 Sept 2024",
      fid: "FID123870981123",
      farmerName: "Ramappa",
    ...
    },
    {
      ...
      cropDetails: "Crop B",
      fcDetails: "FC456",
      initialWeighment: "15kg",
      price: "25000",
    },
  ]);

  const navigate = useNavigate();
  const handleDistribute = (_id) => {
...
const acceptSuccess = () => {
  ...
  return (
    <Layout title="Final Weighment">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">Final Weighment</Block.Title>
          </Block.HeadContent>
        </Block.HeadBetween>
      </Block.Head>
