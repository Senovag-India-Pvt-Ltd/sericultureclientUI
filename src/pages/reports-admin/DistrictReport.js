...
//   };
  ...
  const exportCsv = (e) => {
    ...
    api
      .post(
        baseURLReport + `excel-report/district-report`,
        {
      ...
      .then((response) => {
        ...
        link.download = `district_report.csv`;
  ...
  return (
    <Layout title={t("District Report", { ns: "reports" })}>
      <style>{districtReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("District Report", { ns: "reports" })}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
