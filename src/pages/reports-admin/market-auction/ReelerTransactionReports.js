...
function ReelerTransactionReports() {
  ...
  return (
    <Layout title={t("Reeler Transaction Report")}>
      <style>{reelerTransactionReportsStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Reeler Transaction Report")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              {/* <ul className="d-flex">
                <li>
...
const reelerTransactionReportsStyles = `
  .sh-page-header {
    padding: 20px 24px;
