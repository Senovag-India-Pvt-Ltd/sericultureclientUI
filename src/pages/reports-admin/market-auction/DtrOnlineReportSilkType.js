...
function DtrOnlineReportSilkType() {
  ...
  const exportCsv = (e) => {
    ...
    api
      .post(
        baseURLReport + `excel-report/dtr-report-silk`,
        {
  ...
  const generateDtrReport = async () => {
    ...
    try {
      const response = await api.post(
        baseURLReport + `dtr-online-report-silk`,
        {
          marketId: data.marketId,
          ...
          .then((response) => {
            if (!response.data.content.error) {
              if (response.data.content.traderLicenseNumber) {
                ...
                api
                  .post(baseURLMarket + `auction/report/getDTROnlineReportForSilkType`, {
                    marketId: marketId,
                    // godownId: godownId,
...
export default DtrOnlineReportSilkType;
