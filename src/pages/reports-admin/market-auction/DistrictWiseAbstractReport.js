...
function DistrictWiseAbstractReport() {
  ...
  return (
    <Layout title="District Wise Abstract">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">District Wise Abstract</Block.Title>
          </Block.HeadContent>
          <Block.HeadContent>
            {/* <ul className="d-flex">
              <li>
...
export default DistrictWiseAbstractReport;
