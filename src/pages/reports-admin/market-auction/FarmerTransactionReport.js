...
function FarmerTransactionReport() {
  ...
  return (
    <Layout title={t("Farmer Transaction Report")}>
      <style>{farmerTransactionReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Farmer Transaction Report")}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              {/* <ul className="d-flex">
                <li>
...
const farmerTransactionReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
