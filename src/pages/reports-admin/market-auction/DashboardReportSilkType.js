...
function DashboardReportSilkType() {
  ...
  const generateDashboardReport = async () => {
    ...
    api
      .post(baseURLMarket + `auction/report/getDashboardReportSilkType`, {
        marketId: data.marketId,
        dashboardReportDate: formattedPendingDate,
      })
      .then((response) => {
                    ...
                    <Col lg="12">
                      ...
                      <tr>
                        ...
                        <h2 className="text-centre">
                          ...
                          <tr>
                            <td style={styles.ctstyle}>{t("Total Traders")}:</td>
                            {/* <td>107(Active)</td>
                          <td>253(Paid)</td> */}
                            {dashboardList.map((dashboard) => (
                              <>
                                <td style={styles.ctstyle}>
                                  {dashboard.totalTraders}
                                </td>
                              </>
                            ))}
                          </tr>
...
export default DashboardReportSilkType;
