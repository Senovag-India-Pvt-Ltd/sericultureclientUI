...
function FormReportByDist() {
  ...
  const postData = (event) => {
    const { districtId, marketId, fromDate,toDate } = data;
  ...
  return (
    <Layout title={t("District Wise Abstract District")}> {/* Add t function */}
      <style>{formReportByDistStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("District Wise Abstract District")}</Block.Title> {/* Add t function */}
            </Block.HeadContent>
            <Block.HeadContent>
