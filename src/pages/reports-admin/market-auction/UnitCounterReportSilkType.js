...
function UnitCounterReportSilkType() {
  ...
  const postData = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // event.stopPropagation();
      api
        .post(baseURLMarket + `auction/report/getUnitCounterReportSilkType`, {
          marketId: marketId,
          godownId: godownId,
  ...
  const exportCsv = (e) => {
    const { marketId,godownId ,fromDate, toDate, traderLicenseNumber } = data;
    const formattedFromDate =
    ...
    api
      .post(
        baseURLReport + `excel-report/unit-counter-report-silk`,
        {
                      ...
                      <tbody>
                        {counterData.map((list, i) => (
                          <tr key={i}>
                            ...
                            <td>{list.traderLicenseNumber}</td>
...
export default UnitCounterReportSilkType;
