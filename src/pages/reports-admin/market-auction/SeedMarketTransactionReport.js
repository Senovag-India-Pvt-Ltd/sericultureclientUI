...
function SeedMarketTransactionReport() {
  ...
  return (
    <Layout title={t("Seed Market Transaction Report")}>
      <style>{seedMarketTransactionReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Seed Market Transaction Report")}</Block.Title>
            </Block.HeadContent>
          </Block.HeadBetween>
        </div>
      </Block.Head>
...
const seedMarketTransactionReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
