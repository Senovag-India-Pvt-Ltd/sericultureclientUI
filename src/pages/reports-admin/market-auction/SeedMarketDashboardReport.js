...
function SeedMarketDashboardReport() {
  ...
  return (
    <Layout title={t("Seed Market Dashboard")}>
      <style>{seedMarketDashboardReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Seed Market Dashboard")}</Block.Title>
            </Block.HeadContent>
          </Block.HeadBetween>
        </div>
      </Block.Head>
...
const seedMarketDashboardReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
