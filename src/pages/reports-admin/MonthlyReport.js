...
//   };
  ...
  const exportCsv = (e) => {
    ...
    api
      .post(
        baseURLReport + `excel-report/monthly-report`,
        {
  ...
  return (
    <Layout title={t("Monthly Report", { ns: "reports" })}>
      <style>{monthlyReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Monthly Report", { ns: "reports" })}</Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
