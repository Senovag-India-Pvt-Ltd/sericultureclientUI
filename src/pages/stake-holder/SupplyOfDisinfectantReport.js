...
import SupplyOfDisinfectantsToFarmerEdit from "../chawki-management/SupplyOfDisinfectantsToFarmerEdit";

const baseURL = process.env.REACT_APP_API_BASE_URL_MASTER_DATA;
const baseURLDBT = process.env.REACT_APP_API_BASE_URL_DBT;
const baseURLFarmer = process.env.REACT_APP_API_BASE_URL_CHAWKI_MANAGEMENT;

function SupplyOfDisinfectantReport() {
  ...
  const exportCsv = (e) => {
    api
      ...
      .then((response) => {
        ...
        link.download = `supply_of_disinfectant_report.csv`;
