...
function ExternalUnitRegister() {
  ...
  return (
    <Layout title="External Units Registration(CRC,RSP,NSSO)">
      <style>{externalUnitFormStyles}</style>
      <Block.Head>
          ...
          <Row className="g-3 ">
            <Card>
              <Card.Header className="sh-section-header">
                <Icon name="building" />
                <span>{t("External Units Registration(CRC,RSP,NSSO)")}</span>
              </Card.Header>
              <Card.Body>
        ...
        <Modal.Body className="px-4 py-3">
          ...
          <Form noValidate validated={validatedVbAccount} onSubmit={handleAdd}>
            <Row className="g-3">
              ...
              <Col lg="12">
                <div className="d-flex justify-content-end gap-2 sh-modal-footer">
                  <div className="gap-col">
