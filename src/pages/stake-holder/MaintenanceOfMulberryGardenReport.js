...
function MaintenanceOfMulberryGardenReport() {
  ...
  return (
    <Layout title={t("Mulberry Garden Report")}>
      <style>{maintenanceOfMulberryGardenReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Mulberry Garden Report")}</Block.Title>
            </Block.HeadContent>
...
const maintenanceOfMulberryGardenReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
