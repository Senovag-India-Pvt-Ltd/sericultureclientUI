...
useEffect(() => {
  ...
  return (
    <Layout title={t("Training Achievement Report")}>
      <style>{trainingAchievementReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Training Achievement Report")}</Block.Title>
            </Block.HeadContent>
...
const trainingAchievementReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
