...
function MaintenanceOfPiercedCocoonsReport() {
  ...
  const search = (e) => {
    api
      .post(
        baseURLFarmer + `PiercedCocoons/maintenanceOfPiercedCocoonsDetails`,
        {},
        {
          params: {
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLFarmer + `PiercedCocoons/maintenanceOfPiercedCocoonsReport`,
        {},
        {
          params: {
            raceId: data.raceId || 0,
      ...
      .then((response) => {
        ...
        link.download = `maintenance_of_pierced_cocoons_report.xlsx`;
  ...
  return (
    <Layout title={t("Maintenance Of Pierced Cocoons Report")}>
      <style>{maintenanceOfPiercedCocoonsReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Maintenance Of Pierced Cocoons Report")}</Block.Title>
            </Block.HeadContent>
...
const maintenanceOfPiercedCocoonsReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default MaintenanceOfPiercedCocoonsReport;
