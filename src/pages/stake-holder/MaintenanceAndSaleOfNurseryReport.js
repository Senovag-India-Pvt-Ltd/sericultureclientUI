...
function MaintenanceeAndSaleOfNurseryReport() {
  ...
  const search = (e) => {
    api
      .post(
        baseURLFarmer + `Maintenance-sale/primaryMaintenanceAndSaleOfNurseryDetails`,
        {},
        {
          params: {
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLFarmer + `Maintenance-sale/maintenance-and-sale-report`,
        {},
        {
          params: {
            districtId: data.districtId || 0,
      ...
      .then((response) => {
        ...
        link.download = `maintenance_and_sale_of_report.xlsx`;
  ...
  return (
    <Layout title={t("Maintenance And Sale of Nursery Report")}>
      <style>{maintenanceAndSaleOfNurseryReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Maintenance And Sale of Nursery Report")}</Block.Title>
            </Block.HeadContent>
...
const maintenanceAndSaleOfNurseryReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default MaintenanceeAndSaleOfNurseryReport;
