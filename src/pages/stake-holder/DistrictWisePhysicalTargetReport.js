...
function DistrictWisePhysicalTargetReport() {
  ...
  const search = (e) => {
    api
      .post(
        baseURLFarmer + `productionTargets/getDistrictWisePhysicalTargetsDetails`,
        {},
        {
          params: {
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLFarmer + `productionTargets/getDistrictWisePhysicalTargetsReport`,
        {},
        {
          params: {
            financialYearId: data.financialYearId || 0,
      ...
      .then((response) => {
        ...
        link.download = `physical_targets_report.xlsx`;
  ...
  return (
    <Layout title={t("District Wise Physical Target Details Report")}>
      <style>{districtWisePhysicalTargetReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("District Wise Physical Target Details Report")}</Block.Title>
            </Block.HeadContent>
...
const districtWisePhysicalTargetReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default DistrictWisePhysicalTargetReport;
