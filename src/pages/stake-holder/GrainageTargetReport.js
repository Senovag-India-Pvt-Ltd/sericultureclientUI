...
function GrainageTargetReport() {
  ...
  return (
    <Layout title={t("Grainage Target Details Report")}>
      <style>{grainageTargetReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Grainage Target Details Report")}</Block.Title>
            </Block.HeadContent>
...
const grainageTargetReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
