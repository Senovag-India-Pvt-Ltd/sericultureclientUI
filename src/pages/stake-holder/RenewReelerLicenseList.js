...
function RenewReelerLicenseList() {
  ...
  return (
    <Layout title={t("Renewal of Reeler License Report")}>
      <style>{renewReelerLicenseListStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Renewal of Reeler License Report")}</Block.Title>
            </Block.HeadContent>
...
const renewReelerLicenseListStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default RenewReelerLicenseList;
