...
function RangeWiseMulberryTargetReport() {
  ...
  const search = (e) => {
    api
      .post(
        baseURLFarmer + `mulberryTargets/getRangeWiseMulberryTargetsDetails`,
        {},
        {
          params: {
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLFarmer + `mulberryTargets/getRangeWiseMulberryTargetsReport`,
        {},
        {
          params: {
            financialYearId: data.financialYearId || 0,
      ...
      .then((response) => {
        ...
        link.download = `range_wise_mulberry_targets_report.xlsx`;
  ...
  return (
    <Layout title={t("Range Wise Area Under Mulberry Target Details Report")}>
      <style>{rangeWiseMulberryTargetReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Range Wise Area Under Mulberry Target Details Report")}</Block.Title>
            </Block.HeadContent>
...
const rangeWiseMulberryTargetReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default RangeWiseMulberryTargetReport;
