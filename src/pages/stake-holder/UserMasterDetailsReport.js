...
function UserMasterDetailsReport() {
  ...
  return (
    <Layout title={t("User Details Report")}>
      <style>{userMasterDetailsReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("User Details Report")}</Block.Title>
            </Block.HeadContent>
...
const userMasterDetailsReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
