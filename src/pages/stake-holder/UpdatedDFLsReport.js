...
function UpdatedDFLsReport() {
  ...
  const search = (e) => {
    api
      .post(
        baseURLFarmer + `chowkimanagement/getVerifiedDFLDetails`,
        {},
        {
          params: {
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLFarmer + `chowkimanagement/getVerifiedDFLReport`,
        {},
        {
          params: {
             raceId: data.raceId || 0,
      ...
      .then((response) => {
        ...
        link.download = `verified_dfl_report.xlsx`;
  ...
  return (
    <Layout title={t("Verified DFL Details Report")}>
      <style>{updatedDFLsReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Verified DFL Details Report")}</Block.Title>
            </Block.HeadContent>
...
export default UpdatedDFLsReport;
