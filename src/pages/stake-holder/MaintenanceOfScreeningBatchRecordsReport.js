...
const handleDateChange = (date, type) => {
  ...
  return (
    <Layout title={t("Maintenance Of Screening Bath Records Bed Wise Details Report")}>
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">{t("Maintenance Of Screening Bath Records Bed Wise Details Report")}</Block.Title>
          </Block.HeadContent>
