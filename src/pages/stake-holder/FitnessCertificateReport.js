...
function FitnessCertificateReport() {
  ...
  const search = (e) => {
    api
      .post(
        baseURLFarmer + `cropInspection/getFitnessCertificateDetails`,
        {},
        {
          params: {
            tscId: data.tscId || 0,
  ...
  const exportCsv = (e) => {
    api
      .post(
        baseURLFarmer + `cropInspection/getFitnessCertificateReport`,
        {},
        {
          params: {
            tscId: data.tscId || 0,
      ...
      .then((response) => {
        ...
        link.download = `fitness_certificate_report.xlsx`;
  ...
  return (
    <Layout title={t("Fitness Details Report")}>
      <style>{fitnessCertificateReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Fitness Details Report")}</Block.Title>
            </Block.HeadContent>
...
const fitnessCertificateReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
...
export default FitnessCertificateReport;
