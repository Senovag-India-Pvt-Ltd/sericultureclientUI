...
function PreparationOfEggsDFLsReport() {
  ...
  return (
    <Layout title={t("Added DFLs Details Report")}>
      <style>{preparationOfEggsDFLsReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Added DFLs Details Report")}</Block.Title>
            </Block.HeadContent>
...
const preparationOfEggsDFLsReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
