...
function MaintenanceOfScreeningBatchAssessmentReport() {
  ...
  const exportCsv = (e) => {
    api
      ...
      .then((response) => {
        ...
        link.download = `maintenance_screening_batch_assessment_report.xlsx`;
  ...
  return (
    <Layout title={t("Maintenance Of Screening Batch Assessment Details Report")}>
      <style>{maintenanceOfScreeningBathAssessmentReportStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">{t("Maintenance Of Screening Batch Assessment Details Report")}</Block.Title>
            </Block.HeadContent>
...
const maintenanceOfScreeningBathAssessmentReportStyles = `
  .sh-page-header {
    padding: 20px 24px;
