...
function TrainingDeputationTrackerEdit() {
  ...
  return (
    <Layout title={t("Edit Training Deputation Tracker Details")}>
      <style>{trainingDeputationTrackerEditStyles}</style>
      <Block.Head>
        <div className="sh-page-header">
          <Block.HeadBetween>
            <Block.HeadContent>
              <Block.Title tag="h2" className="sh-page-title">
                {t("Edit Training Deputation Tracker Details")}
              </Block.Title>
            </Block.HeadContent>
            <Block.HeadContent>
              <ul className="d-flex">
      ...
      <Block className="mt-n4 sh-form-wrap">
        <Form noValidate validated={validated} onSubmit={postData}>
            ...
            <Card.Header className="sh-section-header">
              <Icon name="edit" />
              <span>{t("Edit Training Deputation Tracker Details")}</span>
            </Card.Header>
              <Card.Body>
                {loading ? (
...
const trainingDeputationTrackerEditStyles = `
  .sh-page-header {
    padding: 20px 24px;
